...
public class MonsterStatusEffect
{
  ...
  public MonsterStatusEffect (int skill, int duration, long value, int effectSkillLevel)
  {
    this.skill = skill;
    this.duration = duration;
    this.value = value;
    this.effectSkillLevel = effectSkillLevel;
    setStartTime(System.currentTimeMillis());
    setCancelTask(duration);
  }

  public MonsterStatusEffect (int skill, int duration, long value, int effectSkillLevel, int interval)
  {
    this.skill = skill;
    this.duration = duration;
    this.value = value;
  ...
  public int getEffectSkillLevel ()
  {
    return effectSkillLevel;
  }

  public void setEffectSkillLevel (int effectSkillLevel)
  {
    this.effectSkillLevel = effectSkillLevel;
  }
}
