...
public class MapleClient
{
  ...
  private final int unionLevel = 0;
  ...
  private final Map<Integer, List<Pair<String, String>>> customDatas = new HashMap<>();
  private final Map<Integer, String> customKeyValue = new ConcurrentHashMap<>();
  private final Map<MapleQuest, MapleQuestStatus> quests = new ConcurrentHashMap<>();
      ...
      if (this.quests != null)
      {
        ...
        for (MapleQuestStatus q : this.quests.values())
        {
          ...
          if (q.hasMobKills())
          {
            ...
            {
              int mob = iterator.next().intValue();
  ...
  public void loadCustomDatas()
  {
    ...
    try
    {
      ...
      while (rs.next())
      {
        ...
        this.customDatas.get(Integer.valueOf(id)).add(new Pair<>(rs.getString("key"), rs.getString("value")));
      }
    }
    catch (Exception e)
    {
  ...
  public void saveCustomDataToDB(Connection con)
  {
    ...
    try
    {
      if (this.customDatas != null)
      {
        ...
        {
          pse.setInt(2, customData.getKey().intValue());
  ...
  public void saveCustomKeyValueToDB(Connection con)
  {
    ...
    try
    {
      if (this.customKeyValue != null)
      {
        ...
        {
          pse.setInt(2, q.getKey().intValue());
  ...
  public void setCustomData(int id, String key, String value)
  {
    if (this.customDatas.containsKey(Integer.valueOf(id)))
    {
      ...
      this.customDatas.get(Integer.valueOf(id)).add(new Pair<>(key, value));
    }
    else
    {
  ...
  public int chargePoint()
  {
    ...
    for (int i = 0; i < 3; i++)
    {
      ...
      String str = year + StringUtil.getLeftPaddedStr(String.valueOf(month), '0', 2);
