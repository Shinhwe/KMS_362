...
{
  private static final MapleDataProvider dataRoot = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wz") + "/Item.wz"));
  ...
  private static final Map<Integer, Integer> petWonderGrade = new HashMap<>();
