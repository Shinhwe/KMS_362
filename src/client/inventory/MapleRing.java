...
public class MapleRing implements Serializable
{
  ...
  public static long[] makeRing(int itemid, MapleCharacter partner1, MapleCharacter partner2)
  {
    ...
    catch (java.sql.SQLIntegrityConstraintViolationException mslcve)
    {
      return ringID;
    }
    catch (SQLException ex)
    {
      Logger.getLogger(MapleRing.class.getName()).log(Level.SEVERE, null, ex);
    }
    return ringID;
  }
