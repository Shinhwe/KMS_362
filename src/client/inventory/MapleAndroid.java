...
public class MapleAndroid implements Serializable
{
  ...
  public static final MapleAndroid create(int itemid, long uniqueid)
  {
    ...
    return create(itemid, uniqueid, aInfo.left.left.get(Randomizer.nextInt(aInfo.left.left.size())).intValue(), aInfo.left.right.get(Randomizer.nextInt(aInfo.left.right.size())).intValue(), aInfo.mid.get(Randomizer.nextInt(aInfo.mid.size())).intValue(), aInfo.right.intValue());
  }
