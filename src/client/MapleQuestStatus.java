    ...
    /*     */
{
  ...
  private final int maxMob(int mobid)
  {
    ...
    {
      /* 106 */
      if (qs.getKey().intValue() == mobid)
      {
        /* 107 */
        return qs.getValue().intValue();
        /*     */
      }
      /*     */
    }
  ...
  public final boolean mobKilled(int id, int skillID, MapleCharacter chr)
  {
    ...
    {
      /* 146 */
      if (questCount(mo.getKey().intValue(), id))
      {
        /* 147 */
        int mobb = maxMob(mo.getKey().intValue());
        /* 148 */
        if (mo.getValue().intValue() >= mobb)
        {
          /* 149 */
          return false;
          /*     */
        ...
        if (mo.getKey().intValue() == 9101025)
        {
          ...
          {
            /* 154 */
            this.killedMobs.put(mo.getKey(), Integer.valueOf(Math.min(mo.getValue().intValue() + 1, mobb)));
            /*     */
          }
          /* 156 */
        }
        else if (mo.getKey().intValue() == 9101067)
        {
          /* 157 */
