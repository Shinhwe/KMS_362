...
public class MapleCharacter extends AnimatedMapleMapObject implements Serializable
{
  ...
  public static ScheduledFuture<?> XenonSupplyTask;
  ...
  private final List<PlatformerRecord> PfRecords;
  private final long lastExceedTime;
  private final long lastBulletUsedTime;
  private final int[] RestArrow;
  private final List<MapleMapItem> pickPocket;
  private final Map<String, String> keyValues;
  private final List<Integer> cashwishlist;
  ...
  public long lastInstallMahaTime, lastRecoverScrollGauge, cooldownforceBlood, cooldownEllision, lastDistotionTime, lastNemeaAttackTime, lastGerionAttackTime, lastBonusAttckTime, lastElementalGhostTime, lastDrainAuraTime, lastShardTime, lastPinPointRocketTime, lastDeathAttackTime, lastChargeEnergyTime, lastThrowBlastingTime, lastBlizzardTempestTime, lastRoyalKnightsTime, lastCrystalGateTime, lastSungiAttackTime, lastDisconnectTime;
  public int unstableMemorize, ignoreDraco, lastHowlingGaleObjectId, scrollGauge, shadowBite, curseBound, editionalTransitionAttack, lastCardinalForce, cardinalMark, flameDischargeRegen, striker3rdStack, mascotFamilier, shadowerDebuff, shadowerDebuffOid, maelstrom, lastPoseType, energy, serpent, blessMark, blessMarkSkill, fightJazz, guidedBullet, graveObjectId;
  public int 렐릭게이지;
  public int 에인션트가이던스;
  ...
  public int lightning, siphonVitality, armorSplit, PPoint, combination, killingpoint, stackbuff, combinationBuff, BULLET_SKILL_ID, SpectorGauge, LinkofArk, FlowofFight, Stigma, bulletParty;
  ...
  private long monsterComboTime;
  private long lastCreationTime;
  private byte deathcount, gmLevel, gender, secondgender, initialSpawnPoint, skinColor, secondSkinColor, guildrank, allianceRank, cardStack, wolfscore, sheepscore, pandoraBoxFever, world, fairyExp, numClones, subcategory;
  private short level;
  ...
  private int hair, basecolor, addcolor, baseprob, secondbasecolor, secondaddcolor, secondbaseprob, secondhair, face, secondface, demonMarking, mapid, fame, pvpExp, pvpPoints, totalWins, totalLosses, guildid, fallcounter, maplepoints, nxcredit, acash, chair, itemEffect, points, vpoints, itcafetime, rank, rankMove, jobRank, jobRankMove, marriageId, marriageItemId, dotHP, honourExp, honorLevel, ignitionstack, arcaneAim, listonation, elementalCharge, lastElementalCharge, reinCarnation, transformCooldown;
  ...
  public static final MapleCharacter ReconstructChr (final CharacterTransfer ct, final MapleClient client, final boolean isChannel)
  {
    ...
    for (Map.Entry<Integer, Object> qs : ct.Quest.entrySet())
    {
      ...
      queststatus_from.setQuest(qs.getKey().intValue());
    ...
    try
    {
      ...
      if (channelserver)
      {
        ...
        for (MapleInventoryType type : MapleInventoryType.values())
        {
          ...
          {
            /*  2700 */
            for (Map.Entry<Long, Item> mit : ItemLoader.INVENTORY.loadItems(false, charid, type).entrySet())
            {
              /*  2701 */
        ...
        while (rs.next())
        {
          ...
          {
            /*  2779 */
            if (a.getLeft().getId() == skid && /*  2780 */ a.getMid().skillevel >= skl)
            {
              /*  2781 */
              pass = true;
              break;
        ...
        while (rs.next())
        {
          ...
          if (skil == null && /*  2815 */ !GameConstants.isBeginnerJob(skid / 10000) && skid / 10000 != 900 && skid / 10000 != 800 && skid / 10000 != 9000)
          {
            /*  2816 */
        ...
        /*  2927 */
        ps = con.prepareStatement("SELECT * FROM inner_ability_skills WHERE player_id = ?");
        /*  2928 */
        ps.setInt(1, charid);
        /*  2929 */
        rs = ps.executeQuery();
  ...
  public void handleAdditionalSkills (long time)
  {
    ...
    if (this.getSkillLevel(2300009) > 0)
    {
      ...
      if (this.getBuffedEffect(SecondaryStat.BlessingAnsanble) == null)
      {
        if (size > 0)
        {
          this.setSkillCustomInfo(2320013, (long) size * x, 0L);
    ...
    if (GameConstants.isKadena(this.getJob()) && this.getSkillLevel(400041074) > 0 && this.getSkillCustomValue(400441774) == null)
    {
      ...
      this.setSkillCustomInfo(400441774, 0L, effect.getX() * 1000L);
    }
    if (GameConstants.isAngelicBuster(this.getJob()))
    {
      if (this.getBuffedValue(400051046) && this.getSkillCustomValue(400151046) == null)
      {
        ...
        if (summon2 != null)
        {
          ...
          this.setSkillCustomInfo(400151046, 0L, effect.getU() * 1000L);
        }
      }
    }
    else if (GameConstants.isZero(this.getJob()))
    {
      if (this.getSkillCustomValue0(101000201) > 0L)
      {
        ...
        int maxTf = (100) + a * 10 + (this.getGender() == 1 && this.getSkillLevel(101100203) > 0 ? 30 : 0);
    ...
    {
      List<MapleMapObject> objs = this.getMap().getMapObjectsInRange(this.getTruePosition(), 100000.0, Collections.singletonList(MapleMapObjectType.MONSTER));
      ...
      if (this.getSkillLevel(162101012) > 0)
      {
        ...
        if (this.getSkillCustomValue(162101112) == null)
        {
          if (this.getSkillCustomValue0(162101012) < (long) effect.getW2())
          {
            ...
            this.setSkillCustomInfo(162101112, 0L, effect.getZ() * 1000L);
          }
      ...
      if (this.getSkillLevel(162121042) > 0)
      {
        ...
        if (this.getSkillCustomValue(162121142) == null)
        {
          if (this.getSkillCustomValue0(162121042) < (long) effect.getU())
          {
            ...
            this.setSkillCustomInfo(162121142, 0L, effect.getW() * 1000L);
          }
      ...
      switch (mist.getSource().getSourceId())
      {
        ...
        case 4121015:
        {
          ...
          while (mobs.hasNext())
          {
            ...
            if (!mob2.isBuffed(4121015) && (!mob2.getStats().isBoss() || this.getSkillLevel(4120048) > 0))
            {
        ...
        case 162111003:
        {
          ...
          for (final MapleCharacter chr2 : this.getMap().getAllChracater())
          {
            ...
            {
              heal = true;
              mist.setBufftime(System.currentTimeMillis() + mist.getSource().getZ() * 1000L);
            }
            if (mist.getBox().contains(chr2.getTruePosition()))
            {
              if (mist.getOwner().getId() == chr2.getId())
  ...
  public void handleSummons (final long time)
  {
    ...
    if (this.getBuffedValue(400011077))
    {
      ...
      if ((summon = this.getSummon(400011077)) != null && time - this.lastNemeaAttackTime >= effect.getX() * 1000L)
      {
        this.lastNemeaAttackTime = System.currentTimeMillis();
        this.getMap().broadcastMessage(CField.SummonPacket.DeathAttack(summon));
      }
      else if ((summon = this.getSummon(400011078)) != null && time - this.lastGerionAttackTime >= effect.getZ() * 1000L)
      {
  ...
  public void handleHealSkills (final long time)
  {
    ...
    if (this.getSkillLevel(5100013) > 0)
    {
      ...
      if (time - this.lastHealTime >= endurance.getW() * 1000L)
      {
        this.lastHealTime = System.currentTimeMillis();
    ...
    else if (this.getSkillLevel(11110025) > 0)
    {
      ...
      if (time - this.lastHealTime >= willofSteal.getW() * 1000L)
      {
        this.lastHealTime = System.currentTimeMillis();
    ...
    else if (this.getSkillLevel(61110006) > 0)
    {
      ...
      if (time - this.lastHealTime >= selfRecovery.getW() * 1000L)
      {
        this.lastHealTime = System.currentTimeMillis();
  ...
  {
    this.setKeyValue(53714, "atk", String.valueOf(attack));
  ...
  public void addAttackerSkill (final int attack)
  {
    ...
    this.setKeyValue(53714, "atk", String.valueOf(attack + k));
    if (this.getBuffedEffect(80002924) != null)
    {
      this.autoDeregisterBuffStats(80002924, true);
    }
  ...
  public Map<SecondaryStat, Pair<Integer, Integer>> autoDeregisterBuffStats (int sourceId, boolean overwrite)
  {
    ...
    for (Pair<SecondaryStat, SecondaryStatValueHolder> effect : this.effects)
    {
      ...
      SecondaryStatValueHolder vh = effect.right;
      if (vh != null && vh.effect.getSourceId() == sourceId)
      {
        removes.add(new Pair(effect.left, vh));
        statups.put(effect.left, new Pair<Integer, Integer>(vh.value, vh.localDuration));
      }
  ...
  public Map<SecondaryStat, Pair<Integer, Integer>> deregisterBuffStats (int sourceId, List<SecondaryStat> stats, boolean overwrite, boolean auto)
  {
    ...
    for (Pair<SecondaryStat, SecondaryStatValueHolder> effect : this.effects)
    {
      List<MapleSummon> summon;
      SecondaryStatValueHolder vh = effect.right;
      if ((stats.contains(effect.left) || vh != null && effect.left.isStacked() && vh.effect.getSourceId() == sourceId && !overwrite && !auto) && vh.effect.getSourceId() == sourceId)
      {
        removes.add(new Pair(effect.left, vh));
        statups.put(effect.left, new Pair<Integer, Integer>(vh.value, vh.localDuration));
      }
...
//                }
  ...
  public void cancelEffect (final SecondaryStatEffect effect, final List<SecondaryStat> stats, final boolean overwrite, final boolean auto)
  {
    ...
    switch (effect.getSourceId())
    {
      ...
      case 400001030:
      {
        if (!overwrite)
        {
          ...
          this.addCooldown(effz.getSourceId(), System.currentTimeMillis(), effz.getY() * 1000L);
          break;
        }
        break;
      }
      ...
      case 400011015:
      {
        this.getClient().getSession().writeAndFlush(CField.rangeAttack(400011025, Collections.singletonList(new RangeAttack(400011025, this.getPosition(), 0, 0, 7))));
        break;
      }
      case 400001045:
      {
      ...
      case 400031005:
      {
        while (summons1.hasNext())
        {
          ...
          {
            final boolean remove = (effect.getSourceId() == 400031005) == (summon.getSkill() != GameConstants.getSelectJaguarSkillId(GameConstants.getMountItem(33001001, this)));
            if (!remove)
            {
              continue;
            }
    ...
    if (!overwrite)
    {
      ...
      if (effect.getSourceId() == 400011047)
      {
        ...
        this.client.getSession().writeAndFlush(CField.rangeAttack(400011047, Collections.singletonList(new RangeAttack(400011085, this.getTruePosition(), 0, 1, 0))));
      }
  ...
  public void cancelEffectFromBuffStat (final SecondaryStat stat)
  {
    ...
    {
      this.cancelEffect(this.checkBuffStatValueHolder(stat).effect, Collections.singletonList(stat));
    }
  }
  ...
  public void cancelEffectFromBuffStat (final SecondaryStat stat, final int from)
  {
    ...
    {
      this.cancelEffect(this.checkBuffStatValueHolder(stat, from).effect, Collections.singletonList(stat));
    }
  }
  ...
  public void dispel ()
  {
    if (!this.isHidden())
    {
      for (final Pair<SecondaryStat, SecondaryStatValueHolder> data : this.effects)
      {
        ...
        {
          this.cancelEffect(mbsvh.effect, Collections.singletonList(data.left));
        }
      }
    }
  }
  ...
  public void dispelSkill (final int skillid)
  {
    for (final Pair<SecondaryStat, SecondaryStatValueHolder> mbsvh : this.effects)
    {
      ...
      {
        this.cancelEffect(mbsvh.right.effect, Collections.singletonList(mbsvh.left));
        break;
      }
    }
  }
  ...
  public boolean addProfessionExp (final int id, final int expGain)
  {
    ...
    if (newExp >= GameConstants.getProfessionEXP(ret))
    {
      ...
      {
        this.addKV(id + "lv", String.valueOf(Integer.parseInt(this.getV(id + "lv")) + 1));
        if (Integer.parseInt(this.getV(id + "lv")) >= 13)
        {
          this.addKV(id + "lv", "12");
        }
    ...
    {
      this.addKV(id + "EXP", String.valueOf(Integer.parseInt(this.getV(id + "EXP")) + expGain));
    }
  ...
  public void playerDead ()
  {
    ...
    while (this.getBuffedValue(400011010))
    {
      ...
      this.addCooldown(400011010, System.currentTimeMillis(), this.getBuffedEffect(400011010).getZ() * 1000L);
  ...
  public void gainExpMonster (final long gain, final boolean show, final boolean white)
  {
    ...
    {
      this.setKeyValue(1472, "exp", String.valueOf(arcaneStone + total));
    }
    if (total > 0L)
    {
  ...
  public void AddBloomingCoin (int add, Point point)
  {
    ...
    if (add > 0)
    {
      ...
      if (getKeyValue(100794, "today") + add >= ((Calendar.getInstance().get(7) == 7 || Calendar.getInstance().get(7) == 1) ? 6000L : 3000L))
      {
        ...
        add -= minus;
        setKeyValue(100794, "point", String.valueOf(getKeyValue(100794, "point") + add));
      }
      if (lock)
      {
        setKeyValue(100794, "today", String.valueOf((Calendar.getInstance().get(7) == 7 || Calendar.getInstance().get(7) == 1) ? 6000 : 3000));
    ...
    if (add > 0)
    {
      setKeyValue(100794, "today", String.valueOf(getKeyValue(100794, "today") + add));
    }
  }
  ...
  public void AddCoin (final int questid, int add, final boolean ig)
  {
    ...
    if (add > 0 && !ig)
    {
      ...
      if (this.getKeyValue(questid, "today") + add >= ((Calendar.getInstance().get(7) == 7 || Calendar.getInstance().get(7) == 1) ? 600 : 300))
      {
        ...
        add -= minus;
        this.setKeyValue(questid, "point", String.valueOf(this.getKeyValue(questid, "point") + add));
      }
      if (lock)
      {
        this.setKeyValue(questid, "today", String.valueOf((Calendar.getInstance().get(7) == 7 || Calendar.getInstance().get(7) == 1) ? 600 : 300));
    ...
    if (add > 0 && !ig)
    {
      this.setKeyValue(questid, "today", String.valueOf(this.getKeyValue(questid, "today") + add));
    }
  }
  ...
  public void AddCoinAcc (final int questid, int add, final boolean ig)
  {
    ...
    if (add > 0 && !ig)
    {
      ...
      if (this.client.getCustomKeyValue(questid, "week") + add >= 400L)
      {
        ...
        add -= minus;
        this.client.setCustomKeyValue(questid, "point", String.valueOf(this.client.getCustomKeyValue(questid, "point") + add));
      }
      if (lock)
      {
    ...
    if (add > 0 && !ig)
    {
      this.client.setCustomKeyValue(questid, "week", String.valueOf(this.client.getCustomKeyValue(questid, "week") + add));
    }
  }
  ...
  public void showNote ()
  {
    ...
    try
    {
      int count = 0;
      con = DatabaseConnection.getConnection();
      ps = con.prepareStatement("SELECT count(*) rowCount FROM notes WHERE `to`= ? AND `type` = 6", 1005, 1008);
  ...
  public void showsendNote ()
  {
    ...
    try
    {
      int count = 0;
      con = DatabaseConnection.getConnection();
      ps = con.prepareStatement("SELECT count(*) rowCount FROM `notes` WHERE `from`= ? AND `type` = 7", 1005, 1008);
      ps.setString(1, this.getName());
      rs = ps.executeQuery();
      if (rs.next())
      {
  ...
  public void updateOneInfo (final int questid, final String key, final String value)
  {
    ...
    this.updateInfoQuest(questid, changed ? newQuest.substring(0, newQuest.toString().length() - 1) : newQuest.toString());
  }
  ...
  public void removeStolenSkill (int skillID)
  {
    ...
    {
      if (this.stolenSkills.get(i).left == skillID)
      {
        if (this.stolenSkills.get(i).right.booleanValue())
        {
          this.unchooseStolenSkill(skillID);
        }
        count = cc;
      ...
      if (GameConstants.getJobNumber(this.stolenSkills.get(i).left) != jobid)
      {
        continue;
      }
      ++cc;
  ...
  public void giveHoyoungGauge (final int skillid)
  {
    ...
    if (sk != null)
    {
      ...
      statups.put(SecondaryStat.HoyoungThirdProperty, new Pair<Integer, Integer>(this.useChun ? 1 : 0, 0));
  ...
  public void handlePossession (final int type)
  {
    ...
    if (this.getSkillCustomValue0(63101001) == (effect.getV() + 1) * 100L && type != 3)
    {
      givebuff = false;
    }
    if (givebuff)
    {
      ...
      if (this.getSkillCustomValue0(63101001) > (effect.getV() + 1) * 100L)
      {
        this.setSkillCustomInfo(63101001, (effect.getV() + 1) * 100L, 0L);
      }
  ...
  public void handleStackskill (final int skillid, final boolean use)
  {
    ...
    if (use)
    {
      ...
      this.setSkillCustomInfo(skillid - 1, 0L, effect.getU() * 1000L);
    }
  ...
  public void setDeathCount (final byte de)
  {
    ...
    else if (this.getMapId() == 262031300)
    {
      ...
      this.getClient().send(CWvsContext.onFieldSetVariable("DeathCount", String.valueOf(deathcouint)));
  ...
  {
    this.setKeyValue(500629, "point", String.valueOf(a));
    this.client.setKeyValue("유니온코인", String.valueOf(a));
  }
  ...
  public void AddAllUnionCoin (final int a)
  {
    ...
    this.setKeyValue(500629, "point", String.valueOf(Integer.parseInt(this.client.getKeyValue("유니온코인")) + a));
    this.client.setKeyValue("유니온코인", String.valueOf(Integer.parseInt(this.client.getKeyValue("유니온코인")) + a));
  }
  ...
  public void RefreshUnionRaid (final boolean enter)
  {
    ...
    String hours = String.valueOf(ocal.get(11));
    String mins = String.valueOf(ocal.get(12));
    String secs = String.valueOf(ocal.get(13));
    ...
    if (this.getUnionEndTime() > 0L)
    {
      ...
      if (nujuk + allnujuk >= 10000000000000L)
      {
        ...
        {
          this.client.setKeyValue("UnionLaidLevel", String.valueOf(Integer.parseInt(this.client.getKeyValue("UnionLaidLevel")) + 1));
        }
        else
        {
  ...
  public int getV (final String k, int defaultValue)
  {
    if (this.keyValues.containsKey(k))
    {
      return Integer.parseInt(this.keyValues.get(k));
    }

    return defaultValue;
  }

  public long getV (final String k, long defaultValue)
  {
    if (this.keyValues.containsKey(k))
    {
      return Long.parseLong(this.keyValues.get(k));
    }

    return defaultValue;
  }

  public double getV (final String k, double defaultValue)
  {
    if (this.keyValues.containsKey(k))
    {
      return Double.parseDouble(this.keyValues.get(k));
    }
  ...
  public void addKV (final String k, int v)
  {
    this.keyValues.put(k, String.valueOf(v));
  }

  public void addKV (final String k, long v)
  {
    this.keyValues.put(k, String.valueOf(v));
  }

  public void addKV (final String k, Boolean v)
  {
    this.keyValues.put(k, String.valueOf(v));
  }
  ...
  public void AutoTeachSkillZero ()
  {
    if (this.getJob() > 99)
    {
      ...
      final int minus = Integer.parseInt(job.substring(job.length() - this.minusValue()));
      ...
      {
        this.TeachSkillZero(this.getJob() - Integer.parseInt(job.substring(job.length() - 2)));
  ...
  {
    final MapleData data = MapleDataProviderFactory.getDataProvider(MapleDataProviderFactory.fileInWZPath("Skill.wz")).getData(StringUtil.getLeftPaddedStr(String.valueOf(job), '0', 3) + ".img");
    byte maxLevel = 0;
  ...
  public void AutoTeachSkill ()
  {
    if (this.getJob() > 99)
    {
      ...
      if (minus > 0 && this.getJob() - this.plusAlpha() != 2000 && this.getJob() - this.plusAlpha() != 3000)
      {
        this.TeachSkill(this.getJob() - Integer.parseInt(job.substring(job.length() - 2)));
        for (int i = 0; i < this.getJob() % 10 + 1; ++i)
        {
  ...
  public void removeSkillCustomInfo (int skillid)
  {
    ...
    if (skillid == 993192800)
    {
      ...
      {
        /* 16165 */
        getClient().send(CField.PunchKingPacket(this, 0, 4));
        /* 16166 */
    ...
    if (ServerConstants.warpMap == skillid)
    {
      ...
      {
        /* 16175 */
        boolean give = getBuffedEffect(SecondaryStat.RideVehicle) != null && /* 16177 */ getBuffedEffect(SecondaryStat.RideVehicle).getSourceId() / 10000 == 8000;
        /* 16176 */
        /* 16178 */
        ...
        if (give)
        {
          ...
          setKeyValue(100161, "point", String.valueOf(getKeyValue(100161, "point") + 2L));
        }
      }
    }
  }
  ...
  {
    int size = (int) getKeyValue(100000, String.valueOf(id));
    if (size == -1)
    {
      size = 0;
      setKeyValue(100000, String.valueOf(id), "0");
    }
    return size;
  }
  ...
  public void addCustomItem (int id)
  {
    ...
    setKeyValue(100000, String.valueOf(id), String.valueOf(++size));
  }
  ...
  public void equipCustomItem (int id)
  {
    ...
    setKeyValue(100000 + ci.getType().ordinal(), "equip", String.valueOf(id));
  }
  ...
  public void ReHolyUnityBuff (final SecondaryStatEffect effect)
  {
    ...
    final List<MapleMapObject> affecteds = this.getMap().getMapObjectsInRect(bounds, Collections.singletonList(MapleMapObjectType.PLAYER));
    if (this.getParty() != null)
    {
  ...
  public void ResetData (boolean weekly, boolean acc)
  {
    ...
    if (weekly)
    {
      if (acc)
      {
        for (Map.Entry<Integer, String> q : getClient().getCustomKeyValue().entrySet())
        {
          if (q.getKey().intValue() == 501367)
          {
            ...
            this.client.setCustomKeyValue(q.getKey().intValue(), "reward", bosslist);
            continue;
          }
          if (q.getKey().intValue() >= 501470 && q.getKey().intValue() <= 501496)
          {
            this.client.setCustomKeyValue(q.getKey().intValue(), "state", "0");
            this.client.setCustomKeyValue(q.getKey().intValue(), "count", "0");
          }
        }
        for (Pair<Integer, String> keyz : clientCustomDatasWeek)
        {
          if (this.client.getCustomData(keyz.getLeft().intValue(), keyz.getRight()) != null)
          {
            this.client.setCustomData(keyz.getLeft().intValue(), keyz.getRight(), "0");
          }
        }
        ...
        {
          if (this.client.getCustomKeyValueStr(keyz.getLeft().intValue(), keyz.getRight()) != null)
          {
            if (keyz.getLeft().intValue() == 501468 && keyz.getRight().equals("reward"))
            {
              String bosslist = "";
              for (int i = 0; i < ServerConstants.NeoPosList.size(); i++)
              {
              ...
              this.client.setCustomKeyValue(keyz.getLeft().intValue(), keyz.getRight(), bosslist);
              continue;
            }
            this.client.setCustomKeyValue(keyz.getLeft().intValue(), keyz.getRight(), "0");
          }
        }
      }
      else
      {
        ...
        {
          if (getKeyValue(keyz.getLeft().intValue(), keyz.getRight()) >= 0L)
          {
            setKeyValue(keyz.getLeft().intValue(), keyz.getRight(), (keyz.getLeft().intValue() == 1068) ? "60" : "0");
          }
        }
      }
    }
    else if (acc)
    {
      ...
      for (Pair<Integer, String> keyz : clientCustomDatas)
      {
        ...
        {
          this.client.setCustomData(keyz.getLeft().intValue(), keyz.getRight(), "0");
          if (keyz.getLeft().intValue() == 238 && keyz.getRight().equals("T"))
          {
      ...
      {
        if (quest.getKey().getId() == 16011 || quest.getKey().getId() == 16012)
        {
          quest.getValue().setStatus((byte) 0);
          quest.getValue().setCustomData("");
          this.client.send(CWvsContext.InfoPacket.updateQuest(quest.getValue()));
    ...
    else
    {
      ...
      for (Pair<Integer, String> keyz : DateKeyValues)
      {
        if (getKeyValue(keyz.getLeft().intValue(), keyz.getRight()) > 0L)
        {
          setKeyValue(keyz.getLeft().intValue(), keyz.getRight(), "0");
        }
      }
  ...
  public void CombokillHandler (final MapleMonster monster, final int type, final int multikill)
  {
    ...
    if (multikill >= 3)
    {
      ...
      if (this.getKeyValue(51351, "startquestid") == 49007L || this.getKeyValue(51351, "startquestid") == 49008L || (this.getKeyValue(51351, "startquestid") == 49009L && this.getKeyValue(51351, "queststat") == 2L))
      {
        ...
        this.setKeyValue(51351, "multikill", String.valueOf(this.getKeyValue(51351, "multikill") + 1L));
    ...
    else if (!GameConstants.isContentsMap(player.getMapId()))
    {
      ...
      {
        player.addKV("d_combo", String.valueOf(player.getMonsterCombo()));
      }
  ...
  public void gainDonationSkill (int skillid)
  {
    ...
    if (dskill != null && (this.getKeyValue(201910, "DonationSkill") & dskill.getValue()) == 0)
    {
      ...
      this.setKeyValue(201910, "DonationSkill", String.valueOf(data));
  ...
  public void maxskill (int i)
  {
    ...
    MapleData data = MapleDataProviderFactory.getDataProvider(MapleDataProviderFactory.fileInWZPath("Skill.wz")).getData(StringUtil.getLeftPaddedStr(String.valueOf(i), '0', 3) + ".img");
    byte maxLevel = 0;
  ...
  {
    MapleData data = MapleDataProviderFactory.getDataProvider(MapleDataProviderFactory.fileInWZPath("Skill.wz")).getData(StringUtil.getLeftPaddedStr(String.valueOf(getJob()), '0', 3) + ".img");
  ...
  private class MapleCharacterManagement implements Runnable
  {
    ...
    public void handleMobs (final long time)
    {
      ...
      if ((mob = MapleCharacter.this.getMap().getMonsterById(8880000)) != null || (mob = MapleCharacter.this.getMap().getMonsterById(8880002)) != null || (mob = MapleCharacter.this.getMap().getMonsterById(8880010)) != null)
      {
        ...
        boolean damaged = MapleCharacter.this.getTruePosition().getX() <= mob.getTruePosition().getX() - pix || MapleCharacter.this.getTruePosition().getX() >= mob.getTruePosition().getX() + pix;
        final Map<SecondaryStat, Pair<Integer, Integer>> statups2 = new HashMap<SecondaryStat, Pair<Integer, Integer>>();
        statups2.put(SecondaryStat.MobZoneState, new Pair<Integer, Integer>(damaged ? 0 : 1, mob.getObjectId()));
    ...
    public void handleEtcs (final long time)
    {
      ...
      {
        MapleCharacter.this.setKeyValue(210416, "NowDeadTime", String.valueOf(MapleCharacter.this.getKeyValue(210416, "NowDeadTime") - 1L));
      ...
      if (MapleCharacter.this.getKeyValue(27040, "runnigtime") > 0L)
      {
        ...
        if (kc.getDayt() == MapleCharacter.this.getKeyValue(27040, "equipday") && kc.getMonth() == MapleCharacter.this.getKeyValue(27040, "equipmonth") && exppen != null)
        {
          ...
          MapleCharacter.this.setKeyValue(27040, "runnigtime", String.valueOf(runnigtime + 1L));
        ...
        else
        {
          ...
          if (itemexppendent)
          {
            ...
            MapleCharacter.this.setKeyValue(27040, "firstequiptimemil", String.valueOf(System.currentTimeMillis()));
            MapleCharacter.this.setKeyValue(27040, "equipday", String.valueOf(kc.getDayt()));
      ...
      if ((MapleCharacter.this.getMap().isSpawnPoint() || MapleCharacter.this.getMap().isTown()) && !GameConstants.isContentsMap(MapleCharacter.this.getMap().getId()) && !GameConstants.보스맵(MapleCharacter.this.getMap().getId()) && !GameConstants.사냥컨텐츠맵(MapleCharacter.this.getMap().getId()) && !GameConstants.튜토리얼(MapleCharacter.this.getMap().getId()) && !GameConstants.로미오줄리엣(MapleCharacter.this.getMap().getId()) && !GameConstants.피라미드(MapleCharacter.this.getMap().getId()))
      {
        ...
        {
          MapleCharacter.this.addKV("lastSudden", String.valueOf(System.currentTimeMillis()));
        }
      ...
      if (MapleCharacter.this.getInventory(MapleInventoryType.EQUIPPED).getItem((short) (-29)) != null)
      {
        ...
        if (itemid2 >= 1182001 && itemid2 <= 1182005)
        {
          ...
          {
            MapleCharacter.this.addKV("DawnItem", String.valueOf(itemid2));
          }
        ...
        for (final MapleMonster monster : MapleCharacter.this.getMap().getAllMonster())
        {
          if (monster.getOwner() == MapleCharacter.this.getId())
          {
            ...
            if (monster.getId() == mobid)
            {
              ...
              {
                MapleCharacter.this.getClient().setKeyValue("UnionLaidLevel", String.valueOf(Integer.parseInt(MapleCharacter.this.getClient().getKeyValue("UnionLaidLevel")) + 1));
              }
              else
              {
    ...
    public void handleSkillOptions (final long time)
    {
      ...
      {
        boolean read = !MapleCharacter.this.getBuffedValue(400021006) || MapleCharacter.this.getBuffedOwner(400021006) == MapleCharacter.this.id;
        if (read)
        {
