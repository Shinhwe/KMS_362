...
public class GMCommand
{
  ...
  public static class 룬 extends CommandExecute
  {
    public int execute (MapleClient c, String[] splitted)
    {
      ...
      Point poss = (c.getPlayer().getMap()).monsterSpawn.get(sppoint).getPosition();
  ...
  public static class SpawnPortal extends CommandExecute
  {
    public int execute (MapleClient c, String[] splitted)
    {
      ...
      MapleRandomPortal portal = new MapleRandomPortal(Integer.parseInt(splitted[1]), c.getPlayer().getTruePosition(), c.getPlayer().getMapId(), c.getPlayer().getId(), true, 1L);
