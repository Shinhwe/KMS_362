    ...
    /*     */
{
  ...
  /*  47 */   private final ItemLoader factory = ItemLoader.CASHSHOP;
  /*  48 */   private final List<Item> inventory = new ArrayList<>();
  /*  49 */   private final List<Long> uniqueids = new ArrayList<>();
  ...
  public CashShop(int accountId, int characterId, int jobType) throws SQLException
  {
    ...
    /*  54 */
    for (Pair<Item, MapleInventoryType> item : this.factory.loadCSItems(false, accountId).values())
    {
      /*  55 */
    ...
    try
    {
      ...
      while (rs.next())
      {
        ...
        if (packages != null && packages.size() > 0)
        {
          ...
          {
            int packageItem = iterator.next().intValue();
            /* 212 */
  ...
  public void sendedNote(int uniqueid)
  {
    ...
    {
      /* 255 */
      if (this.uniqueids.get(i).intValue() == uniqueid)
      {
        /* 256 */
