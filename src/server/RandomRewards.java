...
public class RandomRewards
{
  ...
  {
    return compiledGold.get(Randomizer.nextInt(compiledGold.size())).intValue();
  }
  
  public static int getSilverBoxReward()
  {
    return compiledSilver.get(Randomizer.nextInt(compiledSilver.size())).intValue();
  }
  
  public static int getFishingReward()
  {
    return compiledFishing.get(Randomizer.nextInt(compiledFishing.size())).intValue();
  }
  
  public static int getRandomReward()
  {
    return compiledRandomItem.get(Randomizer.nextInt(compiledRandomItem.size())).intValue();
  }
  
  public static int getTheSeedReward()
  {
    return compiledTheSeedItems.get(Randomizer.nextInt(compiledTheSeedItems.size())).intValue();
  }
  
  public static int getPeanutReward()
  {
    return compiledPeanut.get(Randomizer.nextInt(compiledPeanut.size())).intValue();
  }
  ...
  public static int getEventReward()
  {
    ...
    if (chance < 66)
    {
      return compiledEventC.get(Randomizer.nextInt(compiledEventC.size())).intValue();
    }
    if (chance < 86)
    {
      return compiledEventB.get(Randomizer.nextInt(compiledEventB.size())).intValue();
    }
    if (chance < 96)
    {
      return compiledEventA.get(Randomizer.nextInt(compiledEventA.size())).intValue();
    }
    return compiledEvent.get(Randomizer.nextInt(compiledEvent.size())).intValue();
  }
  ...
  public static int getDropReward()
  {
    ...
    if (chance < 76)
    {
      return compiledDrops.get(Randomizer.nextInt(compiledDrops.size())).intValue();
    }
    if (chance < 96)
    {
      return compiledDropsB.get(Randomizer.nextInt(compiledDropsB.size())).intValue();
    }
    return compiledDropsA.get(Randomizer.nextInt(compiledDropsA.size())).intValue();
  }
