...
public class InnerAbillity
{
  ...
  private static final List<Triple<Byte, Integer, int[]>> rarelists = new ArrayList<>();
  private static final List<Triple<Byte, Integer, int[]>> epiclists = new ArrayList<>();
  private static final List<Triple<Byte, Integer, int[]>> uniquelists = new ArrayList<>();
  private static final List<Triple<Byte, Integer, int[]>> legendlists = new ArrayList<>();
  ...
  public InnerSkillValueHolder renewSkill(int rank, boolean circulator)
  {
    ...
    return new InnerSkillValueHolder(randomSkill, skillLevel, (byte) SkillFactory.getSkill(randomSkill).getMaxLevel(), randomSkillTriple.getLeft());
  }
