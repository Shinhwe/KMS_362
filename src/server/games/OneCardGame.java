...
public class OneCardGame
{
  ...
  public void skipPlayer()
  {
    ...
    if (getLastPlayer().getCards().size() >= 17)
    { // 파산
      setFire(0);
  ...
  public void endGame(OneCardPlayer winner, boolean error)
  {
    ...
    for (OneCardPlayer bp : this.getPlayers())
    {
      if (bp.getPlayer().getId() == winner.getPlayer().getId())
      {
        ...
        {
          bp.getPlayer().setKeyValue(501215, "today", String.valueOf(bp.getPlayer().getKeyValue(501215, "today") + 10L));
      ...
      else
      {
        ...
        {
          bp.getPlayer().setKeyValue(501215, "today", String.valueOf(bp.getPlayer().getKeyValue(501215, "today") + 5L));
