...
public class MapleLifeFactory
{
  ...
  public static int getNPCLocation(int npcid)
  {
    ...
    {
      return NPCLoc.get(Integer.valueOf(npcid)).intValue();
    }
  ...
  public static MapleMonsterStats getMonsterStats(int mid)
  {
    ...
    if (stats == null)
    {
      ...
      try
      {
        monsterData = data.getData(StringUtil.getLeftPaddedStr(mid + ".img", '0', 11));
      }
      ...
      if (monsterSkillData != null)
      {
        ...
        while (monsterSkillData.getChildByPath(Integer.toString(k)) != null)
        {
          ...
          if (ms != null)
          {
            ms.setOnlyFsm((ms.getSkillId() != 215 || ms.getSkillLevel() != 4) && ((onlyFsm > 0)));
      ...
      if (monsterAtt != null)
      {
        ...
        while (monsterAtt.getChildByPath(Integer.toString(k)) != null)
        {
          ...
          if (monsterAtt.getChildByPath(k + "/callSkill") != null)
          {
            MapleData callSkillData = monsterAtt.getChildByPath(k + "/callSkill");
            int m = 0;
          ...
          if (monsterAtt.getChildByPath(k + "/callSkillWithData") != null)
          {
            MapleData callSkillData = monsterAtt.getChildByPath(k + "/callSkillWithData");
  ...
  public static int getRandomNPC()
  {
    ...
    while (ret <= 0)
    {
      ret = vals.get(Randomizer.nextInt(vals.size())).intValue();
      if (npcNames.get(Integer.valueOf(ret)).contains("MISSINGNO"))
      {
        ret = 0;
      }
    }
