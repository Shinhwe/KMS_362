        ...
        case 114:
          if (this.lt != null && this.rb != null && skill && monster != null)
          {
            ...
            for (MapleMapObject mons : objects)
            {
              ...
              player.getMap().broadcastMessage(MobPacket.healEffectMonster(mons.getObjectId(), this.skillId, this.skillLevel));
            }
            break;
          }
          if (monster != null)
        ...
        case 238:
          switch (this.skillLevel)
          {
            ...
            case 10:
            {
              ...
              monster.setLastSkillUsed(this, System.currentTimeMillis(), Randomizer.rand(10, 20) * 1000);
              player.getMap().broadcastMessage(MobPacket.BossLucid.doFairyDustSkill(this.skillLevel, arrayList));
        ...
        case 242:
          switch (this.skillLevel)
          {
            ...
            case 4:
            {
              ...
              {
                mob.getMap().broadcastMessage(MobPacket.BlockAttack(mob, arrayList));
              ...
              for (MapleCharacter chr : monster.getMap().getAllCharactersThreadsafe())
              {
                ...
                chr.getClient().getSession().writeAndFlush(MobPacket.BossWill.WillSpiderAttack(monster.getId(), this.skillId, this.skillLevel, typee, null));
              }
              ...
              Timer.MobTimer.getInstance().schedule(() ->
              {
                ...
                for (MapleCharacter chr : monster.getMap().getAllCharactersThreadsafe())
                {
                  ...
                  chr.getClient().getSession().writeAndFlush(MobPacket.BossWill.WillSpiderAttack(monster.getId(), this.skillId, this.skillLevel, 0, null));
        ...
        case 262:
          if (this.skillLevel == 1)
          {
            if (player.getSkillCustomValue(26201) == null)
            {
              ...
              Timer.BuffTimer.getInstance().schedule(() -> player.getClient().getSession().writeAndFlush(SLFCGPacket.MakeBlind(0, 0, 0, 0, 0, 300, 0)), 1000L);
            }
          }
          break;
        case 263:
