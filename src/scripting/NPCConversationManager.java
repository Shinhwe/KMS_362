...
//        c.getPlayer().getStat().recalcLocalStats(c.getPlayer());
  ...
  public void sendCustom(String text, byte type, int idd)
  {
    ...
    /*  220 */
    this.c.getSession().writeAndFlush(CField.NPCPacket.getNPCTalks(this.id, (byte) 0, text, "00 01", type, idd));
    /*  221 */
    this.lastMsg = 0;
  }
  ...
  public String getMobName(int mobid)
  {
    ...
    {
      /*  296 */
      if (mobPair.getLeft().intValue() == mobid)
      {
        /*  297 */
  ...
  public int setAvatar(int ticket, int args)
  {
    ...
    if (hairlist.isEmpty() || facelist.isEmpty())
    {
      ...
      {
        /*  765 */
        if (itemPair.getRight().toLowerCase().contains("헤어") || itemPair.getRight().toLowerCase().contains("머리"))
        {
          /*  766 */
        ...
        if (itemPair.getRight().toLowerCase().contains("얼굴"))
        {
          /*  768 */
    ...
    else if (facelist.containsKey(Integer.valueOf(args)))
    {
      ...
      {
        /*  788 */
        String sum = args + String.valueOf(mixranze);
        /*  789 */
  ...
  public int setZeroAvatar(int ticket, int args1, int args2)
  {
    ...
    else if (facelist.containsKey(Integer.valueOf(args1)) || facelist.containsKey(Integer.valueOf(args2)))
    {
      ...
      {
        /*  837 */
        String sum = args1 + String.valueOf(mixranze);
        /*  838 */
      ...
      {
        /*  841 */
        String sum = args2 + String.valueOf(mixranze);
        /*  842 */
  ...
  public void addBoss(String boss)
  {
    ...
    {
      /* 1348 */
      this.c.getPlayer().removeV("bossPractice");
      /* 1349 */
      ...
      for (MaplePartyCharacter chr : getPlayer().getParty().getMembers())
      {
        ...
        if (ch != null)
        {
          ...
          ch.removeV(boss);
          /* 1357 */
          ch.addKV(boss, String.valueOf(System.currentTimeMillis() + 1800000L));
          /* 1358 */
  ...
  public void gainAllAccountPremium(int v3, int v4)
  {
    ...
    try
    {
      ...
      {
        /* 2925 */
        if (existPremium(chrs.get(i).intValue()))
        {
          /* 2926 */
          if (getRemainPremium(chrs.get(i).intValue()) > adate.getTime())
          {
            /* 2927 */
            ps = con.prepareStatement("UPDATE premium SET period = ? WHERE accid = ?");
            /* 2928 */
            ps.setLong(1, getRemainPremium(chrs.get(i).intValue()) + ((long) v3 * 24 * 60 * 60 * 1000));
            /* 2929 */
        ...
        else
        {
          ...
          /* 2946 */
          ps.setInt(1, chrs.get(i).intValue());
          /* 2947 */
          ps.setString(2, "일반");
          /* 2948 */
          ps.setInt(3, 80001535);
    ...
    try
    {
      ...
      if (existPremium(accid))
      {
        ...
        if (getRemainPremium(accid) > adate.getTime())
        {
          ...
          {
            /* 3003 */
            ps.setLong(1, getRemainPremium(accid) + ((long) v3 * 24 * 60 * 60 * 1000));
          }
          else
          {
            /* 3005 */
  ...
  public void logDonator(String log, int previous_points)
  {
    /* 3187 */
    /* 3188 */
    String logg = MapleCharacterUtil.makeMapleReadable(getPlayer().getName()) +
        /* 3189 */
        " [CID: " + getPlayer().getId() + "] " +
        /* 3190 */
        " [Account: " + MapleCharacterUtil.makeMapleReadable(getClient().getAccountName()) + "] " +
        /* 3191 */
        log +
        /* 3192 */
  ...
  public int getNaturalStats(int itemid, String it)
  {
    ...
    {
      /* 3238 */
      return eqStats.get(it).intValue();
    }
    /* 3240 */
    return 0;
  }
  ...
  public void SearchItem(String text, int type)
  {
    ...
    for (Pair<Integer, String> item : ii.getAllEquips())
    {
      ...
      if (item.getRight().toLowerCase().contains(text.toLowerCase()))
      {
        ...
        /* 3507 */
        if (type == 1 && ii.isCash(item.getLeft().intValue()) && item.getLeft().intValue() >= 1000000 && item.getLeft().intValue() / 1000000 == 1)
        {
          /* 3508 */
        ...
        if (type == 0 && item.getLeft().intValue() / 10000 >= 2 && item.getLeft().intValue() / 10000 < 3)
        {
          /* 3511 */
          chat = chat + "\r\n" + color + "#L" + item.getLeft() + "##i" + item.getLeft() + " ##z" + item.getLeft() + "#" + isuse;
          /* 3512 */
        ...
        if (type == 2 && item.getLeft().intValue() / 10000 >= 3 && item.getLeft().intValue() / 10000 <= 5)
        {
          /* 3514 */
          chat = chat + "\r\n" + color + "#L" + item.getLeft() + "##i" + item.getLeft() + " ##z" + item.getLeft() + "#" + isuse;
          /* 3515 */
  ...
  public void UserSoulHandle(int selection)
  {
    ...
    for (List<Pair<Integer, MapleCharacter>> souls : this.c.getChannelServer().getSoulmatch())
    {
      ...
      /* 3560 */
      if (souls.size() == 1 && souls.get(0).left.intValue() == 0 && selection == 0)
      {
        /* 3561 */
  ...
  public void openWeddingPresent(int type, int gender)
  {
    ...
    if (dataEntry != null)
    {
      ...
      if (type == 1)
      {
        ...
        /* 3637 */
        this.c.getSession().writeAndFlush(CWvsContext.showWeddingWishGiveDialog(wishes));
        /* 3638 */
      }
      else if (type == 2)
      {
  ...
  public void gainDonationSkill(int skillid)
  {
    ...
    if (dskill != null && (c.getPlayer().getKeyValue(201910, "DonationSkill") & dskill.getValue()) == 0)
    {
      ...
      c.getPlayer().setKeyValue(201910, "DonationSkill", String.valueOf(data));
  ...
  public String getItemNameById(int itemid)
  {
    ...
    {
      /* 3657 */
      if (itemPair.getLeft().intValue() == itemid)
      {
        /* 3658 */
  ...
  public boolean checkDayItem(String s, int type)
  {
    ...
    if (type == 1)
    {
      ...
      if (chr.getV(s) != null)
      {
        ...
        /* 3871 */
        /* 3873 */
        return after.getTimeInMillis() <= System.currentTimeMillis();
      }
    }
    /* 3877 */
    return true;
  ...
  public void SelectQuest(String quest, int quest1, int quest2, int count)
  {
    ...
    {
      /* 3902 */
      int questid = QuestList.get(Randomizer.rand(0, QuestList.size() - 1)).intValue();
      /* 3903 */
      boolean no = false;
      /* 3904 */
      switch (questid)
      ...
      {
        /* 3933 */
        questid = QuestList.get(Randomizer.rand(0, QuestList.size() - 1)).intValue();
        /* 3934 */
        switch (questid)
        {
          case 35566:
