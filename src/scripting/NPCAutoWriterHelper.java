...
public class NPCAutoWriterHelper
{
  ...
  public final String addInfo(int id)
  {
    ...
    a = a + "\r\n#k";
    for (MapleData d : MapleDataProviderFactory.getDataProvider(new File("wz/String.wz")).getData("Npc.img").getChildByPath(String.valueOf(id)).getChildren())
    {
      if (!d.getName().equals("name") && !d.getName().equals("func"))
      {
        a = a + d.getName() + " : " + d.getData() + "\r\n";
      }
    }
    return a;
  }
