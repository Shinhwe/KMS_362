...
public class CWvsContext
{
  ...
  public static void DamageSkinInfo (MapleCharacter chr, MaplePacketLittleEndianWriter mplew)
  {
    ...
    {
      int skin = (int) chr.getKeyValue(13191, String.valueOf(i));
      mplew.writeInt(skin);
  ...
  public static byte[] charInfo (MapleCharacter chr, boolean isSelf)
  {
    ...
    {
      mplew.writeInt(x.left.intValue());
      mplew.writeLong(x.right.longValue());
    }
    DamageSkinInfo(chr, mplew);
  ...
  public static byte[] MatrixSkillMulti (MapleCharacter chr, int skillid, int level, int unk1, int unk2, int bullet, boolean data, List<Integer> datas, List<MatrixSkill> skills)
  {
    ...
    if (data)
    {
      mplew.writeInt(datas.get(0).intValue());
      mplew.writeInt(datas.get(1).intValue());
      mplew.writeInt(datas.get(2).intValue());
      mplew.writeInt(datas.get(3).intValue());
      mplew.writeInt(datas.get(4).intValue());
      mplew.writeInt(datas.get(5).intValue());
      mplew.write(datas.get(6).intValue());
    }
  ...
  public static byte[] Unlocklinkskill (int oriskillid, Map<Integer, Integer> unlock)
  {
    ...
    {
      mplew.writeInt(skill.getKey().intValue());
      mplew.writeInt(skill.getValue().intValue());
    }
    return mplew.getPacket();
  }
  ...
  public static byte[] onUserSoulMatching (int type, List<Pair<Integer, MapleCharacter>> chrs)
  {
    ...
    if (type == 0 || type == 1 || type == 2 || type == 10)
    {
      ...
      for (Pair<Integer, MapleCharacter> chr : chrs)
      {
        ...
        mplew.writeInt(chr.getLeft().intValue());
  ...
  public static byte[] unionFreeset (MapleClient c, int presetNum)
  {
    ...
    for (int i = 0; i < 8; i++)
    {
      mplew.writeInt((c.getCustomData(500627 + presetNum, String.valueOf(i)) == null) ? i : Integer.parseInt(c.getCustomData(500627 + presetNum, String.valueOf(i))));
    }
    mplew.writeInt(equipped.size());
    for (MapleUnion chr : equipped)
    {
  ...
  public static byte[] equipmentEnchantResult (int op, Equip item, Equip item2, EquipmentScroll scroll, StarForceStats stats, int result, long meso, int starForceSuccessChance, int starForceDownChance, int starForceDestroyChance)
  {
    ...
    switch (op)
    {
      ...
      case 52:
        ...
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Watk)).right.intValue());
        }
        if (EnchantFlag.Matk.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Matk)).right.intValue());
        }
        if (EnchantFlag.Str.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Str)).right.intValue());
        }
        if (EnchantFlag.Dex.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Dex)).right.intValue());
        }
        if (EnchantFlag.Int.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Int)).right.intValue());
        }
        if (EnchantFlag.Luk.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Luk)).right.intValue());
        }
        if (EnchantFlag.Wdef.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Wdef)).right.intValue());
        }
        if (EnchantFlag.Mdef.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Mdef)).right.intValue());
        }
        if (EnchantFlag.Hp.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Hp)).right.intValue());
        }
        if (EnchantFlag.Mp.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Mp)).right.intValue());
        }
        if (EnchantFlag.Acc.check(stats.getFlag()))
        {
          mplew.writeInt((stats.getFlag(EnchantFlag.Avoid)).right.intValue());
        }
  ...
  public static byte[] blizzardTempest (List<Pair<Integer, Integer>> lists)
  {
    ...
    {
      mplew.writeInt(list.left.intValue());
      mplew.writeInt(list.right.intValue());
  ...
  public static class InventoryPacket
  {
    ...
    public static byte[] moveInventoryItem (MapleInventoryType type, List<Pair<Short, Short>> updateSlots)
    {
      ...
      for (Pair<Short, Short> updateSlot : updateSlots)
      {
        mplew.write(2);
        mplew.write(Math.max(1, type.getType()));
        mplew.writeShort(updateSlot.left.shortValue());
        mplew.writeShort(updateSlot.right.shortValue());
      }
      mplew.write(0);
      return mplew.getPacket();
    }
  ...
  public static class BuffPacket
  {
    ...
    public static byte[] giveBuff (Map<SecondaryStat, Pair<Integer, Integer>> statups, SecondaryStatEffect effect, MapleCharacter chr)
    {
      ...
      {
        if (!stat.getLeft().canStack() && !stat.getLeft().isSpecialBuff() && !statups.containsKey(SecondaryStat.KillingPoint) && !statups.containsKey(SecondaryStat.PinkbeanRollingGrade))
        {
          ...
          if (stat.getLeft() == SecondaryStat.KinesisPsychicPoint || stat.getLeft().SpectorEffect() || stat.getLeft() == SecondaryStat.HoyoungThirdProperty || stat.getLeft() == SecondaryStat.TidalForce || stat.getLeft() == SecondaryStat.YetiAnger || stat.getLeft() == SecondaryStat.YetiAngerMode)
          {
            mplew.writeInt(chr.getJob());
          }
          ...
          else if ((stat.getLeft().isItemEffect() && effect.getSourceId() != 135001009) || !effect.isSkill() || SkillFactory.getSkill(effect.getSourceId()) == null)
          {
          ...
          mplew.writeInt((effect == null) ? 0 : stat.right.right.intValue());
        }
      }
      ...
      {
        if (statups.get(SecondaryStat.Judgement).left.intValue() == 1)
        {
          mplew.writeInt(effect.getV());
        }
        else if (statups.get(SecondaryStat.Judgement).left.intValue() == 2)
        {
          mplew.writeInt(effect.getW());
        }
        else if (statups.get(SecondaryStat.Judgement).left.intValue() == 3)
        {
      ...
      {
        switch (statups.get(SecondaryStat.LifeTidal).left.intValue())
        {
          case 1:
      ...
      {
        mplew.writeInt(statups.get(SecondaryStat.MobZoneState).right.intValue());
        mplew.writeInt(-1);
      }
      ...
      {
        mplew.writeInt(statups.get(SecondaryStat.ImmuneBarrier).left.intValue());
      }
      ...
      {
        mplew.writeInt(statups.get(SecondaryStat.IndiePad).left.intValue());
        mplew.writeInt(statups.get(SecondaryStat.RoyalGuardState).left.intValue());
      }
      ...
      for (Pair<SecondaryStat, Pair<Integer, Integer>> stat : newstatups)
      {
        ...
        {
          mplew.writeInt(stat.right.left.intValue());
          mplew.writeInt((stat.left == SecondaryStat.EnergyCharged) ? 0 : chr.getBuffSource(stat.left));
          ...
          {
            mplew.writeShort(stat.right.right.intValue() / 1000);
            continue;
          }
      ...
      boolean unk = statups.containsKey(SecondaryStat.Etherealform) || statups.containsKey(SecondaryStat.Transform) || statups.containsKey(SecondaryStat.IndieJointAttack) || statups.containsKey(SecondaryStat.SwordOfSoulLight) || statups.containsKey(SecondaryStat.RideVehicle) || statups.containsKey(SecondaryStat.SpreadThrow) || statups.containsKey(SecondaryStat.Dike) || statups.containsKey(SecondaryStat.IceAura) || statups.containsKey(SecondaryStat.Novility) || statups.containsKey(SecondaryStat.ThrowBlasting) || statups.containsKey(SecondaryStat.DarknessAura) || statups.containsKey(SecondaryStat.RoyalKnights) || statups.containsKey(SecondaryStat.AbyssalLightning) || statups.containsKey(SecondaryStat.PhotonRay) || statups.containsKey(SecondaryStat.ThanatosDescent) || statups.containsKey(SecondaryStat.DragonPang);
      mplew.write(unk);
      mplew.write(true);
      mplew.write(true);
    ...
    public static void encodeIndieTempStat (MaplePacketLittleEndianWriter mplew, List<Pair<SecondaryStat, Pair<Integer, Integer>>> newstatups, MapleCharacter chr)
    {
      ...
      for (Pair<SecondaryStat, List<SecondaryStatValueHolder>> indiestat : indiestatz)
      {
        ...
        for (SecondaryStatValueHolder indie : indiestat.getRight())
        {
          ...
          {
            mplew.writeInt(list.left);
            mplew.writeInt(list.right);
          }
  ...
  public static class InfoPacket
  {
    ...
    public static byte[] updateQuestMobKills (MapleQuestStatus status)
    {
      ...
      {
        int kills = iterator.next().intValue();
        /* 1740 */
    ...
    public static byte[] GainEXP_Monster (MapleCharacter chr, long gain, boolean white, long flag, int eventBonusExp, int weddingExp, int partyExp, int itemEquipExp, int pcExp, int rainbowWeekExp, int boomupExp, int portionExp, int skillExp, int buffExp, int restExp, int itemExp, int valueExp, int bonusExp, int bloodExp, int iceExp, Pair<Integer, Integer> burningExp, int hpLiskExp, int fieldBonusExp, int eventBonusExp2, int fieldBonusExp2)
    {
      ...
      {
        /* 1784 */
        packet.writeInt(weddingExp);
      }
      /* 1786 */
      if ((flag & 0x20L) != 0L)
      {
        /* 1787 */
        packet.writeInt(partyExp);
      }
      /* 1789 */
      if ((flag & 0x40L) != 0L)
      {
        /* 1790 */
        packet.writeInt(itemEquipExp);
      }
      /* 1792 */
      if ((flag & 0x80L) != 0L)
      {
        /* 1793 */
        packet.writeInt(pcExp);
      }
      /* 1795 */
      if ((flag & 0x100L) != 0L)
      {
        /* 1796 */
        packet.writeInt(rainbowWeekExp);
      }
      /* 1798 */
      if ((flag & 0x200L) != 0L)
      {
        /* 1799 */
        packet.writeInt(boomupExp);
      }
      /* 1801 */
      if ((flag & 0x400L) != 0L)
      {
        /* 1802 */
        packet.writeInt(portionExp);
      }
      /* 1804 */
      if ((flag & 0x800L) != 0L)
      {
        /* 1805 */
        packet.writeInt(skillExp);
      }
      /* 1807 */
      if ((flag & 0x1000L) != 0L)
      {
        /* 1808 */
        packet.writeInt(buffExp);
      }
      /* 1810 */
      if ((flag & 0x2000L) != 0L)
      {
        /* 1811 */
        packet.writeInt(restExp);
      }
      /* 1813 */
      if ((flag & 0x4000L) != 0L)
      {
        /* 1814 */
        packet.writeInt(itemExp);
      }
      /* 1816 */
      if ((flag & 0x10000L) != 0L)
      {
      ...
      {
        /* 1826 */
        packet.writeInt(bonusExp);
      }
      /* 1828 */
      if ((flag & 0x100000L) != 0L)
      {
        /* 1829 */
        packet.writeInt(bloodExp);
      }
      /* 1831 */
      if ((flag & 0x200000L) != 0L)
      {
        /* 1832 */
        packet.writeInt(iceExp);
      }
      /* 1834 */
      if ((flag & 0x400000L) != 0L)
      {
        /* 1835 */
        packet.writeInt(burningExp.left.intValue());
        /* 1836 */
        packet.writeInt(burningExp.right.intValue());
      }
      /* 1838 */
      if ((flag & 0x800000L) != 0L)
      {
        /* 1839 */
        packet.writeInt(hpLiskExp);
      }
      /* 1841 */
      if ((flag & 0x1000000L) != 0L)
      {
        /* 1842 */
        packet.writeInt(fieldBonusExp);
      }
      /* 1844 */
      ...
      {
        /* 1848 */
        packet.writeInt(eventBonusExp2);
      }
      /* 1850 */
      ...
      {
        /* 1854 */
        packet.writeInt(fieldBonusExp2);
      }
      /* 1856 */
