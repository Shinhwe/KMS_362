...
public class CField
{
  ...
  public static byte[] spawnPlayerMapobject(MapleCharacter chr)
  {
    ...
    chr.getEffects().stream().forEach(effect ->
    {
      ...
      {
        statups.put(effect.getLeft(), new Pair<>(Integer.valueOf(effect.getRight().value), Integer.valueOf(effect.right.localDuration)));
      }
    });
    ...
    for (AttackPair oned : attack.allDamage)
    {
      if (oned.attack != null)
      {
        ...
        if (attack.skill == 80001835)
        {
          ...
          {
            mplew.writeLong(eachd.left.longValue());
          }
        }
        else
        {
          for (Pair<Long, Boolean> eachd : oned.attack)
          {
            if (eachd.right.booleanValue() || chr.getStat().getCritical_rate() >= 100 || chr.getSkillCustomValue(3310005) != null || Randomizer.isSuccess(chr.getStat().getCritical_rate()))
            {
              mplew.writeLong(eachd.left.longValue() | 0x8000000000000001L);
              continue;
            }
            mplew.writeLong(eachd.left.longValue());
          }
  ...
  public static void specialChairPacket(MaplePacketLittleEndianWriter mplew, MapleSpecialChair chair)
  {
    ...
    for (int i = 0; i < chair.getPlayers().size(); i++)
    {
      ...
      mplew.writeInt(isCharEnable ? chair.getPlayers().get(i).getPlayer().getId() : 0);
      mplew.write(isCharEnable);
      mplew.writeInt(chair.getPlayers().get(i).getEmotion());
    }
  }
  ...
  public static byte[] skillCooldown(Map<Integer, Integer> datas)
  {
    ...
    {
      mplew.writeInt(GameConstants.getLinkedSkill(data.getKey().intValue()));
      mplew.writeInt(data.getValue().intValue());
    }
    return mplew.getPacket();
  }
  ...
  public static byte[] spawnMist(MapleMist mist)
  {
    ...
    mplew.writeInt(0);
    mplew.writeInt(0);
    mplew.write(mist.getSource() != null && ((mist.getSourceSkill().getId() == 151121041)));
    mplew.write(false);
    mplew.writeZeroBytes(100);
    return mplew.getPacket();
  }
...
//        mplew.write(-1); //274 ++
  ...
  public static byte[] ZeroTag(MapleCharacter chr, byte Gender, int nowhp, int maxhp)
  {
    ...
    packet.writeInt((100) + a * 10 + ((Gender == 1 && chr.getSkillLevel(101100203) > 0) ? 30 : 0));
    return packet.getPacket();
  }
  ...
  public static byte[] bonusAttackRequest(int skillid, List<Triple<Integer, Integer, Integer>> mobList, boolean unk, int jaguarBleedingAttackCount, int... args)
  {
    ...
    {
      pw.writeInt(mob.getLeft().intValue());
      pw.writeInt(mob.getMid().intValue());
      if (skillid == 400041030)
      {
        pw.writeInt(mob.getRight().intValue());
      }
    }
  ...
  public static byte[] addItemMuto(MapleCharacter chr)
  {
    ...
    mplew.writeInt(1);
    mplew.writeInt(chr.getId());
    mplew.writeInt((chr.getRecipe()).left.intValue() - 1599086);
    mplew.writeInt((chr.getRecipe()).right.intValue());
    return mplew.getPacket();
  }
  ...
  public static byte[] SpiritFlow(List<Pair<Integer, Integer>> skills)
  {
    ...
    {
      mplew.writeInt(skill.left.intValue());
      mplew.writeInt(skill.right.intValue());
    }
    return mplew.getPacket();
  }
  ...
  public static byte[] poisonNova(MapleCharacter chr, List<Integer> novas)
  {
    ...
    {
      int nova = iterator.next().intValue();
      mplew.writeInt(nova);
    }
    return mplew.getPacket();
  }
          ...
          switch (atom.getnForceAtomType())
          {
            ...
            default:
              ...
              if (atom.getnForceAtomType() == 62)
              {
                ...
                mplew.writeInt(atom.getDwTargets().size());
                /* 7213 */
                for (Integer dwTarget : atom.getDwTargets()) /* 7214 */
                {
                  mplew.writeInt(dwTarget.intValue());
                }
                break;
  ...
  public static byte[] onUIEventInfo(MapleClient c, boolean open)
  {
    ...
    {
      mplew.writeInt(item.left.intValue());
      mplew.writeInt(item.mid.intValue());
      mplew.writeInt(0);
      mplew.writeInt(0);
      mplew.writeInt(0);
      mplew.write(0);
  ...
  public static byte[] spawnSecondAtoms(int cid, List<SecondAtom> tiles, int spawnType)
  {
    ...
    for (SecondAtom tile : tiles)
    {
      ...
      {
        int point = iterator.next().intValue();
        mplew.writeInt(point);
      }
      i++;
    }
  ...
  public static byte[] showScrollOption(int itemId, int scrollId, StarForceStats es)
  {
    ...
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Watk)).right.intValue());
    }
    if (EnchantFlag.Matk.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Matk)).right.intValue());
    }
    if (EnchantFlag.Str.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Str)).right.intValue());
    }
    if (EnchantFlag.Dex.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Dex)).right.intValue());
    }
    if (EnchantFlag.Int.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Int)).right.intValue());
    }
    if (EnchantFlag.Luk.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Luk)).right.intValue());
    }
    if (EnchantFlag.Wdef.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Wdef)).right.intValue());
    }
    if (EnchantFlag.Mdef.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Mdef)).right.intValue());
    }
    if (EnchantFlag.Hp.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Hp)).right.intValue());
    }
    if (EnchantFlag.Mp.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Mp)).right.intValue());
    }
    if (EnchantFlag.Acc.check(es.getFlag()))
    {
      mplew.writeInt((es.getFlag(EnchantFlag.Avoid)).right.intValue());
    }
  ...
  public static byte[] getBlizzardTempest(List<Triple<Integer, Integer, Integer>> lis)
  {
    ...
    {
      mplew.writeInt(list.getLeft().intValue());
      mplew.writeInt(list.getMid().intValue());
      mplew.writeInt(list.getRight().intValue());
    }
    return mplew.getPacket();
  }
  ...
  public static final byte[] BossMatchingChance(List<Pair<Integer, Integer>> list)
  {
    ...
    {
      mplew.writeInt(li.getLeft().intValue());
      mplew.writeInt(li.getRight().intValue());
    }
    return mplew.getPacket();
  }
  ...
  public static byte[] ChangeSpecialMapEffect(List<Pair<String, Integer>> str)
  {
    ...
    for (Pair<String, Integer> eff : str)
    {
      ...
      mplew.write(eff.getRight().intValue());
    }
    return mplew.getPacket();
  }
  ...
  public static byte[] DojangRank(ResultSet ranks, ResultSet rank, int count) throws SQLException
  {
    ...
    for (i = 1; i <= count; i++)
    {
      ...
      String timerecode = ranks.getInt("floor") + String.valueOf(ranks.getInt("time"));
    ...
    for (i = 1; i <= count; i++)
    {
      ...
      String timerecode = rank.getInt("floor") + String.valueOf(rank.getInt("time"));
      mplew.writeInt(Integer.parseInt(timerecode));
      mplew.writeInt(i);
  ...
  public static byte[] craftFinished2(int cid, int craftID, int ranking, List<Pair<Integer, Short>> itemlist)
  {
    ...
    {
      mplew.writeInt(craftID);
      mplew.writeInt(itemlist.get(i).left.intValue());
      mplew.writeInt(itemlist.get(i).right.shortValue());
      mplew.writeLong(0L);
    }
    mplew.writeInt(0);
    return mplew.getPacket();
  ...
  public static class UIPacket
  {
    ...
    public static byte[] detailShowInfo1(String msg, final int font, final int size, final long color)
    { // 보통 3,15 ,1
      MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
  ...
  public static class SummonPacket
  {
    ...
    public static byte[] summonAttack(MapleSummon summon, int skillid, byte animation, byte tbyte, List<Pair<Integer, List<Long>>> allDamage, int level, Point pos, boolean darkFlare)
    {
      ...
      {
        mplew.writeInt(attackEntry.left.intValue());
        if (attackEntry.left.intValue() > 0)
        {
          mplew.write(7);
    ...
    public static byte[] transformSummon(MapleSummon summon, int type)
    {
      ...
      if (type == 2)
      {
        ...
        {
          mplew.writeInt(i);
          mplew.writeInt(summon.getCrystalSkills().get(i - 1).booleanValue() ? 1 : 0);
        }
      }
      return mplew.getPacket();
    }
