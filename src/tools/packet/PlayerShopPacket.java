...
public class PlayerShopPacket
{
  ...
  public static final byte[] getPlayerStore(MapleCharacter chr, boolean firstTime)
  {
    ...
    {
      mplew.write(storechr.left.byteValue());
      AvatarLook.encodeAvatarLook(mplew, storechr.right, false, (GameConstants.isZero(storechr.right.getJob()) && storechr.right.getGender() == 1));
  ...
  public static byte[] getMiniGame(MapleClient c, MapleMiniGame minigame)
  {
    ...
    {
      mplew.write(visitorz.getLeft().byteValue());
      AvatarLook.encodeAvatarLook(mplew, visitorz.getRight(), false, (GameConstants.isZero(visitorz.right.getJob()) && visitorz.right.getGender() == 1));
