...
public class CashShopOperation
{
  ...
  public static void EnterCS(int playerid, MapleClient c)
  {
    ...
    for (i = 120000000; i < 120000100; i++)
    {
      ...
      /*  82 */
      if (c.getKeyValue(String.valueOf(i)) != null)
      {
        /*  83 */
        int value = Integer.parseInt(c.getKeyValue(String.valueOf(i)));
        /*  84 */
  ...
  public static void updateCharge(MapleClient c)
  {
    ...
    /* 106 */
    String date = CurrentTime.getYear() + StringUtil.getLeftPaddedStr(String.valueOf(CurrentTime.getMonth()), '0', 2);
  ...
  {
    /* 119 */
    c.getSession().writeAndFlush(CField.popupHomePage());
  }
  ...
  public static void mvpGiftPack(MapleClient c)
  {
    ...
    /* 174 */
    String date = CurrentTime.getYear() + StringUtil.getLeftPaddedStr(String.valueOf(CurrentTime.getMonth()), '0', 2) + StringUtil.getLeftPaddedStr(String.valueOf(CurrentTime.getDate()), '0', 2) + StringUtil.getLeftPaddedStr(String.valueOf(CurrentTime.getHour()), '0', 2);
    /* 175 */
  ...
  public static void CouponCode(String code, MapleClient c)
  {
    ...
    /* 269 */
    if (info != null && info.left.booleanValue())
    {
      /* 270 */
      CashItemInfo itez;
      byte slot;
      int type = info.mid.intValue(), item = info.right.intValue();
      try
      {
        /* 272 */
      ...
      switch (type)
      {
        ...
        case 3:
          ...
          /* 305 */
          itemz.put(Integer.valueOf(item), c.getPlayer().getInventory(GameConstants.getInventoryType(item)).getItem(slot));
          break;
  ...
  public static final void BuyCashItem(LittleEndianAccessor slea, MapleClient c, MapleCharacter chr)
  {
    ...
    switch (action)
    {
      ...
      case 3:
        ...
        {
          if (c.getKeyValue(String.valueOf(item.getSN())) != null && item.getLimitMax() <= Integer.parseInt(c.getKeyValue(String.valueOf(item.getSN()))))
          {
            return;
          }
          final int value = (c.getKeyValue(String.valueOf(item.getSN())) != null) ? (Integer.parseInt(c.getKeyValue(String.valueOf(item.getSN()))) + 1) : 1;
          c.setKeyValue(String.valueOf(item.getSN()), String.valueOf(value));
          c.getSession().writeAndFlush(CSPacket.showCount(item.getSN(), value));
        }
        if (item == null)
        {
          c.getSession().writeAndFlush(CSPacket.sendCSFail(0));
      ...
      case 34:
        ...
        {
          /* 638 */
          if (c.getKeyValue(String.valueOf(cashItemInfo2.getSN())) != null
              && /* 639 */ cashItemInfo2.getLimitMax() <= Integer.parseInt(c.getKeyValue(String.valueOf(cashItemInfo2.getSN()))))
          {
            return;
          }
          
          /* 643 */
          int value = (c.getKeyValue(String.valueOf(cashItemInfo2.getSN())) != null) ? (Integer.parseInt(c.getKeyValue(String.valueOf(cashItemInfo2.getSN()))) + 1) : 1;
          /* 644 */
          c.setKeyValue(String.valueOf(cashItemInfo2.getSN()), String.valueOf(value));
          /* 645 */
        ...
        /* 663 */
        if (Arrays.asList(GameConstants.cashBlock).contains(Integer.valueOf(cashItemInfo2.getId())))
        {
          /* 664 */
      ...
      default:
        /* 710 */
        System.out.println("New Action: " + action + " Remaining: " + slea);
        /* 711 */
        c.getSession().writeAndFlush(CSPacket.sendCSFail(0));
        break;
    }
