...
public class LoginInformationProvider
{
  ...
  public final boolean isEligibleItem(int gender, int val, int job, int item)
  {
    if (item < 0)
    {
      System.out.printf("item is <0, isEligibleItem(%d, %d, %d, %d)%n", Integer.valueOf(gender), Integer.valueOf(val), Integer.valueOf(job), Integer.valueOf(item));
      return false;
    }
    ...
    if (our == null)
    {
      System.out.printf("isEligibleItem(%d, %d, %d, %d)%n", Integer.valueOf(gender), Integer.valueOf(val), Integer.valueOf(job), Integer.valueOf(item));
      return false;
    }
