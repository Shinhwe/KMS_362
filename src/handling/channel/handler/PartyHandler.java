  ...
  public static final void PartyOperation(LittleEndianAccessor slea, MapleClient c)
  {
    ...
    switch (operation)
    {
      ...
      case 8:
        ...
        {
          /* 211 */
          c.getPlayer().getQuest_Map().remove(MapleQuest.getInstance(122900));
        }
        else
        {
          /* 213 */
      ...
      case 13:
        ...
        /* 225 */
        c.getSession().writeAndFlush(CWvsContext.PartyPacket.updateParty(c.getChannel(), party, PartyOperation.CHANGE_PARTY_TITLE, partyplayer));
        return;
    }
    /* 228 */
