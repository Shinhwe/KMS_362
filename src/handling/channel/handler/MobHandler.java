...
public class MobHandler
{
  ...
  public static final void MoveMonster(LittleEndianAccessor slea, MapleClient c, MapleCharacter chr)
  {
    ...
    try
    {
      ...
      /*  104 */
      if ((monster.getId() == 8645009 || monster.getId() == 8645066) && ( /*  105 */actionAndDir == 30 || actionAndDir == 31))
      {
        /*  106 */
      ...
      if (!monster.isSkillForbid())
      {
        ...
        if (action >= 13 && action <= 29)
        {
          ...
          if (attackIdx < monster.getStats().getAttacks().size())
          {
            ...
            {
              /*  200 */
              MobSkill msi = MobSkillFactory.getMobSkill(skill.left.intValue(), skill.mid.intValue());
              /*  201 */
              if (msi != null)
              {
                /*  202 */
                if (skill.right.intValue() > 0)
                {
                  /*  203 */
                  msi.setMobSkillDelay(c.getPlayer(), monster, skill.right.intValue(), (short) 0, ((actionAndDir & 0x1) != 0));
                  continue;
                  /*  204 */
                }
          ...
          else if (monster.getNoSkills() > 0)
          {
            ...
            for (MobSkill msi : monster.getSkills())
            {
              ...
              if (time - monster.getLastSkillUsed(msi.getSkillId(), msi.getSkillLevel()) >= 0L)
              {
                ...
                /*  367 */
                if (monster.getHPPercent() <= msi.getHP() && !msi.isOnlyOtherSkill() && !msi.checkCurrentBuff(chr, monster) && ( /*  368 */!msi.isOnlyFsm() || msi.getSkillId() == 223))
                {
                  /*  369 */
      ...
      if (monster.getId() == 8880000 || monster.getId() == 8880002 || monster.getId() == 8880010)
      {
            ...
            && /*  453 */ bOption != 1 && bOption != 0)
        {
          ...
          /*  455 */
          boolean showchat = (monster.getPosition().getX() > 2475.0D && actionAndDir == 31) || (monster.getPosition().getX() < 1090.0D && actionAndDir == 30);
          /*  456 */
          /*  457 */
          /*  459 */
          if (showchat)
      ...
      else if ((monster.getId() == 8880111) ? (( /*  468 */actionAndDir != 26 && actionAndDir != 27)
  ...
  public static final void OrgelHit(LittleEndianAccessor slea, MapleCharacter chr)
  {
    ...
    /*  703 */
    if (Attacker.getId() >= 9833090 && Attacker.getId() <= 9833099 && (( /*  704 */Defender.getId() >= 9833070 && Defender.getId() <= 9833074) || Defender.getId() == 9833100))
    {
      /*  705 */
  ...
  public static final void SpiritHit(LittleEndianAccessor slea, MapleCharacter chr)
  {
    ...
    switch (mob.getId())
    {
      case 8644201:
        /*  729 */
        chr.setKeyValue(16215, "life", String.valueOf(life - 5));
        break;
      case 8644301:
      case 8644302:
      case 8644303:
      ...
      case 8644305:
        /*  736 */
        chr.setKeyValue(16215, "life", String.valueOf(life - 50));
        /*  737 */
        asdf = 0;
        /*  738 */
        for (i = 0; i < 5; i++)
  ...
  public static final void RemoveObstacle(LittleEndianAccessor slea, MapleClient c)
  {
    ...
    for (int i = 0; i < size; i++)
    {
      ...
      if (hit == 1)
      {
        ...
        /* 1284 */
        if (ob != null && ( /* 1285 */c.getPlayer().getMapId() == 450008750 || c.getPlayer().getMapId() == 450008150) && ob.getKey() == 64)
        {
          /* 1286 */
  ...
  public static final void RemoveEnergtSphere(LittleEndianAccessor slea, MapleClient c)
  {
    ...
    else if (!hit)
    {
      ...
      if (mes != null)
      {
        ...
        {
          /* 1334 */
          c.getPlayer().getMap().getNodez().getEnvironments().get(num).setX(mes.getCustomx() + 91);
          /* 1335 */
          c.getPlayer().getMap().getNodez().getEnvironments().get(num).setY(-16);
          /* 1336 */
          c.getPlayer().getMap().getNodez().getEnvironments().get(num).setShow(true);
        }
        /* 1338 */
  ...
  public static final void DemianSwordHandle(LittleEndianAccessor slea, MapleClient c)
  {
    ...
    if (mfs != null && demian != null && mfs.getNodes().size() > 10)
    {
      ...
      /* 1365 */
      if (mfs.getNodes().size() - 1 == count) /* 1366 */
      {
