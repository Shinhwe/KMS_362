    ...
    if (mode == 1)
    {
      ...
      try
      {
        ...
        if (charWithId != null)
        {
          ...
          /* 246 */
          c.getSession().writeAndFlush(CWvsContext.BuddylistPacket.updateBuddylist(buddylist.getBuddies(), ble, (byte) 20));
        }
        else
        {
