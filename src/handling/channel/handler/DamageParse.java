...
public class DamageParse
{
  ...
  public static void applyAttack (final AttackInfo attack, Skill theSkill, final MapleCharacter player, double maxDamagePerMonster, SecondaryStatEffect effect, AttackType attack_type, boolean BuffAttack, boolean energy)
  {
    ...
    block858:
    {
      block859:
      {
        ...
        for (Object oned : attack.allDamage)
        {
          ...
          if (player.getBuffedValue(SecondaryStat.SeaSerpent) != null)
          {
            ...
            if (Arrays.asList(격투스킬).contains(attack.skill))
            {
              ...
              else if (chr.getBuffedValue(5110020))
              {
                ...
                chr.getClient().getSession().writeAndFlush(CField.rangeAttack(5101017, Collections.singletonList(new RangeAttack(5121023, chr.getPosition(), ((attack.facingleft >>> 4 & 0xF) == 0) ? 0 : 1, 0, 1))));
                chr.getClient().getSession().writeAndFlush(CField.rangeAttack(5110018, Collections.singletonList(new RangeAttack(5111019, chr.getPosition(), ((attack.facingleft >>> 4 & 0xF) == 0) ? 0 : 1, 0, 1))));
              }
            }
            else if (attack.skill == 5121007)
            {
              ...
              else if (chr.getBuffedValue(5110020))
              {
                ...
                atoms.add(new SecondAtom(0x24, player.getId(), 0, 5121027, 5000, 0, 15, new Point(monster.getPosition().x, monster.getPosition().y), Collections.singletonList(0)));
          ...
          if (monster != null)
          {
            if (!player.getMonster(9500006) && !player.getMonster(9500007))
            {
              if (Randomizer.nextInt(10000) > probability && !monster.getStats().isBoss())
              { // 대박 사냥
          ...
          if (player.getBuffedValue(SecondaryStat.QuiverCatridge) != null && attack.skill != 400031021 && attack.skill != 95001000 && attack.skill != 3111013 && attack.skill != 3100010 && attack.skill != 400031000)
          {
            ...
            if (player.getRestArrow()[player.getQuiverType() - 1] == 0)
            {
              ...
              else
              {
                ...
                player.getClient().getSession().writeAndFlush(CField.EffectPacket.showEffect(player, 0, 3101009, 57, player.getQuiverType() - 1, 0, (byte) (player.isFacingLeft() ? 1 : 0), true, player.getPosition(), null, null));
          ...
          if (player.getSkillLevel(101120207) > 0)
          {
            ...
            {
              debinrear = true;
              player.getClient().getSession().writeAndFlush(CField.EffectPacket.showEffect(player, 0, 101120207, 4, 0, 0, (byte) (player.isFacingLeft() ? 1 : 0), true, player.getTruePosition(), null, null));
          ...
          if (markOf != null && nk != null)
          {
            ...
            if (attack.skill != 400041038 && attack.skill != 4100012 && attack.skill != 4120019)
            {
              if (monster.isBuffed(markOf.getSourceId()) || !monster.isAlive() && Randomizer.isSuccess(markOf.getProp()))
              {
                ...
                {
                  int i;
                  List<MapleMapObject> objs = player.getMap().getMapObjectsInRange(player.getTruePosition(), 400000.0, Collections.singletonList(MapleMapObjectType.MONSTER));
                  ArrayList<Integer> monsters = new ArrayList<Integer>();
          ...
          {
            List<MapleMapObject> objs = player.getMap().getMapObjectsInRange(player.getTruePosition(), 1000000.0, Collections.singletonList(MapleMapObjectType.MONSTER));
          ...
          if (player.getBuffedValue(400001050) && player.getSkillCustomValue0(400001050) == 400001055L)
          {
            ...
            player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400001055, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
          ...
          if (effect != null && monster.isAlive())
          {
            ...
            if (player.getSkillLevel(101110103) > 0)
            {
              ...
              if (player.getGender() == 1 && Randomizer.isSuccess(stunMastery3.getProp()))
              {
                ...
                statusz.add(new Triple<MonsterStatus, MonsterStatusEffect, Long>(MonsterStatus.MS_MultiPMDR, new MonsterStatusEffect(101110103, stunMastery3.getDuration()), (long) stunMastery3.getY() * monster.getCustomValue0(101110103)));
              }
            }
            if (player.getSkillLevel(101120207) > 0)
            {
              ...
              {
                statusz.add(new Triple<MonsterStatus, MonsterStatusEffect, Long>(MonsterStatus.MS_Burned, new MonsterStatusEffect(101120207, stunMastery3.getDOTTime()), (long) stunMastery3.getDOT() * totDamageToOneMonster / (long) attack.allDamage.size() / 10000L));
              }
            }
            ...
            else if (GameConstants.isCain(player.getJob()) && player.getSkillLevel(63110011) > 0 && monster != null)
            {
              ...
              {
                boolean cast = (attack.skill != 63101104 && attack.skill != 63121141) || monster.getCustomValue(attack.skill) == null;
                if (cast)
                {
            ...
            if (player.getSkillLevel(400041000) > 0 && attack.skill != 400041000 && Randomizer.isSuccess(50))
            {
              ...
              applys2.add(new Pair<MonsterStatus, MonsterStatusEffect>(MonsterStatus.MS_Burned, new MonsterStatusEffect(400040000, 8000, (int) ((long) stunMastery3.getDOT() * totDamageToOneMonster / (long) attack.allDamage.size() / 10000L))));
            }
          ...
          if (player.getSkillLevel(400011116) > 0 && SkillFactory.getSkill(400011116).getSkillList().contains(attack.skill))
          {
            ...
            else if (!player.getBuffedValue(400011116) && attack.targets > 0 && player.skillisCooling(400011116) && !player.skillisCooling(400011117))
            {
              ArrayList<Triple<Integer, Integer, Integer>> mobList = new ArrayList<Triple<Integer, Integer, Integer>>();
              int i = 0;
              for (MapleMapObject o : player.getMap().getMapObjectsInRange(player.getPosition(), 100000.0, Collections.singletonList(MapleMapObjectType.MONSTER)))
              {
                ...
                player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011117, mobList, false, mon.getObjectId()));
              }
              player.addCooldown(400011117, System.currentTimeMillis(), effect2.getX() * 1000);
              player.getClient().getSession().writeAndFlush(CField.skillCooldown(400011117, effect2.getX() * 1000));
            }
          }
          ...
          if (player.getBuffedValue(400011016))
          {
            ...
            if (System.currentTimeMillis() - player.lastInstallMahaTime >= (long) (installMaha.getX() * 1000))
            {
              ...
              player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011020, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
            }
          }
          ...
          if (GameConstants.isIllium(player.getJob()) && monster.getBuff(MonsterStatus.MS_CurseMark) != null && attack.skill != 152001002 && attack.skill != 152120003 && attack.skill != 152120002 && attack.skill != 152120016)
          {
            ...
            player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(skillid, mobList, false, 0));
          }
          ...
          {
            player.lastThunderTime = System.currentTimeMillis();
            player.getClient().getSession().writeAndFlush(CField.rangeAttack(80002890, Collections.singletonList(new RangeAttack(80002890, attack.position, 0, 0, 1))));
          }
        ...
        if (attack.skill == 5121013 || attack.skill == 5221013 || attack.skill == 400051040)
        {
          ...
          else if (player.getSkillLevel(5221013) > 0 && attack.skill == 5221013)
          {
            ...
            for (final int reduceSkill : array2)
            {
              ...
              player.changeCooldown(reduceSkill, (int) (-(player.getCooldownLimit(reduceSkill) / 2L)));
            }
          }
        ...
        if (totDamage > 0L)
        {
          ...
          if (player.getBuffedValue(32101009) && player.getSkillCustomValue(32111119) == null && player.getId() == player.getBuffedOwner(32101009))
          {
            ...
            player.getClient().getSession().writeAndFlush(CField.EffectPacket.showEffect(player, 0, 32101009, 10, 0, 0, (byte) (player.isFacingLeft() ? 1 : 0), true, player.getTruePosition(), null, null));
            ...
            if (player.getParty() != null)
            {
              for (MaplePartyCharacter pc : player.getParty().getMembers())
              {
                ...
                chr.getClient().getSession().writeAndFlush(CField.EffectPacket.showEffect(chr, 0, 32101009, 10, 0, 0, (byte) (chr.isFacingLeft() ? 1 : 0), true, chr.getTruePosition(), null, null));
          ...
          if (player.getBuffedValue(31121002) && System.currentTimeMillis() - player.lastVamTime >= (long) player.getBuffedEffect(31121002).getY() && player.getBuffedEffect(SecondaryStat.DebuffIncHp) == null)
          {
            ...
            player.addHP(Math.min(player.getBuffedEffect(31121002).getW(), totDamage * (long) player.getBuffedEffect(31121002).getX() / 100L));
            if (player.getParty() != null)
            {
              for (MaplePartyCharacter pc : player.getParty().getMembers())
              {
          ...
          {
            player.getClient().getSession().writeAndFlush(CField.rangeAttack(400011131, Collections.singletonList(new RangeAttack(400011132, attack.attackPosition2, 0, 0, 1))));
          }
          ...
          if (Arrays.asList(throw_skillList = new Integer[] { 4121013, 4121017, 4121052, 4001344, 4101008, 4111010, 4111015 }).contains(attack.skill))
          {
            if (player.getBuffedEffect(SecondaryStat.ThrowBlasting) != null && attack.skill != 400041061 && attack.skill != 400041079)
            {
              ...
              player.getClient().getSession().writeAndFlush(CField.rangeAttack(400041061, Collections.singletonList(new RangeAttack(400041079, attack.attackPosition2, 0, 0, 3))));
        ...
        if (GameConstants.isAran(player.getJob()) && attack.skill != 400011122 && player.getBuffedValue(400011121) && System.currentTimeMillis() - player.lastBlizzardTempestTime >= 500L)
        {
          ...
          player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011122, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
        ...
        {
          player.getClient().getSession().writeAndFlush(CField.rangeAttack(400011079, Collections.singletonList(new RangeAttack(400011081, player.getTruePosition(), 0, 0, 0))));
        }
        if (attack.skill == 400011080)
        {
          player.getClient().getSession().writeAndFlush(CField.rangeAttack(400011080, Collections.singletonList(new RangeAttack(400011082, player.getTruePosition(), 0, 0, 0))));
        }
        ...
        if (player.getBuffedEffect(SecondaryStat.CrystalGate) != null)
        {
          ...
          if ((double) (System.currentTimeMillis() - player.lastCrystalGateTime) >= crystalGate.getT() * 1000.0)
          {
            ...
            player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400021111, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
          }
        }
      ...
      else if (attack.skill != 400011118 && !player.skillisCooling(400111119))
      {
        for (SecondAtom at : player.getMap().getAllSecondAtomsThreadsafe())
        {
          ...
          player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011130, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
          break;
        }
      }
    }
    if (attack.skill >= 400051059 && attack.skill <= 400051067 && attack.skill != 400051065 && attack.skill != 400051067)
    {
      ...
      if (attack.isLink || attack.skill == 400051066)
      {
        ...
        if (objs.size() > 0)
        {
          ...
          player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(attack.skill == 400051066 ? 400051067 : 400051065, mobList, false, 0, player.getBuffedValue(400051058) ? 3 : 1, attack.position.x, attack.position.y, player.getBuffedValue(400051058) ? 445 : 565, player.getBuffedValue(400051058) ? 315 : 510));
        }
      }
    }
    ...
    if (player.getSkillLevel(400011048) > 0 && !player.skillisCooling(400011048) && attack.targets > 0 && SkillFactory.getSkill(400011048).getSkillList().contains(attack.skill))
    {
      ...
      player.getClient().getSession().writeAndFlush(CField.EffectPacket.showEffect(player, 0, attackid, 1, 0, 0, (byte) (player.isFacingLeft() ? 1 : 0), true, player.getPosition(), null, null));
      ...
      player.getClient().getSession().writeAndFlush(CField.rangeAttack(attackid, skills));
    ...
    { // 사라졌?
      ...
      {
        player.getClient().getSession().writeAndFlush(CField.rangeAttack(attack.skill, Collections.singletonList(new RangeAttack(400041076, attack.position, 0, 0, 6))));
      }
    ...
    {
      player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400031011, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
    ...
    if (player.getBuffedValue(400011005) && totDamageToOneMonster > 0L)
    {
      ...
      {
        player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011022, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
      ...
      {
        player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011023, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
    ...
    if (player.getBuffedValue(400051010) && !GameConstants.is_forceAtom_attack_skill(attack.skill) && player.getSkillCustomValue(400051010) == null && attack.skill != 25121055 && attack.skill != 25111012)
    {
      ...
      for (RandomSkillEntry info : rse)
      {
        ...
        {
          player.getClient().getSession().writeAndFlush(CField.SpiritFlow(skillList));
        }
    ...
    {
      player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011074, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
      player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011075, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
      player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011076, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
    }
    ...
    {
      player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400051047, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
    }
    if (attack.skill == 155120001 && player.getSkillLevel(400051047) > 0 && player.getCooldownLimit(400051048) == 0L)
    {
      player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400051048, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 0));
    }
    if (attack.skill == 3321014 || attack.skill == 3321016 || attack.skill == 3321018 || attack.skill == 3321020)
    {
      player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(attack.skill + 1, new ArrayList<Triple<Integer, Integer, Integer>>(), true, 600));
    }
    if (attack.skill == 400041042)
    {
      player.getClient().getSession().writeAndFlush(CField.rangeAttack(attack.skill, Collections.singletonList(new RangeAttack(400041043, attack.position, 1, 0, 0))));
    }
    ...
    if (player.getBuffedValue(63121044) && player.getSkillCustomValue(80113017) == null && (long) player.getId() != player.getSkillCustomValue0(63121044))
    {
      ...
      List<MapleMapObject> objs = player.getMap().getMapObjectsInRange(player.getTruePosition(), 600000.0, Collections.singletonList(MapleMapObjectType.MONSTER));
      if (objs.size() > 0)
      {
        for (int i = 1; i <= objs.size(); ++i)
        {
          ...
          player.getClient().getSession().writeAndFlush(CField.rangeAttack(80003017, Collections.singletonList(rg)));
    ...
    if (attack.targets > 0)
    {
      ...
      if (fallingtime != -1)
      {
        player.getClient().getSession().writeAndFlush(CField.setFallingTime(fallingspeed, fallingtime));
      }
    }
    if (monster != null)
    {
      if (monster.getBuff(MonsterStatus.MS_DarkLightning) != null && attack.skill != 400021113 && attack.skill != 32110020 && attack.skill != 32111016 && attack.skill != 32101001 && attack.skill != 32111015 && attack.skill != 400021088)
      {
        ...
        player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(32110020, mobList, false, 0));
        boolean cancel = true;
      ...
      if (GameConstants.isAran(player.getJob()))
      {
        if (SkillFactory.getSkill(400011122).getSkillList().contains(attack.skill) && monster.getCustomValue0(400011121) > 0L && monster.getCustomTime(400011122) != null && player.getBuffedValue(400011123))
        {
          ...
          ArrayList<Triple<Integer, Integer, Integer>> mobList = new ArrayList<Triple<Integer, Integer, Integer>>();
          player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400011122, mobList, true, 0));
        }
    ...
    {
      player.getClient().getSession().writeAndFlush(CField.rangeAttack(400051081, Collections.singletonList(new RangeAttack(400051081, monster.getPosition(), 0, 0, 1))));
    }
    ...
    else if (GameConstants.isCain(player.getJob()) && attack.targets > 0)
    {
      if (attack.targets > 0)
      {
        ...
        if (player.getBuffedValue(400031062) && player.getSkillCustomValue(400031063) == null && attack.skill != 63111012 && attack.skill != 63101006 && attack.skill != 63111010)
        {
          ...
          {
            player.getClient().getSession().writeAndFlush(CField.rangeAttack(effect2.getSourceId(), Collections.singletonList(new RangeAttack(400031063, monster.getPosition(), 0, 0, 1))));
    ...
    else if (GameConstants.isBattleMage(player.getJob()))
    {
      if (player.getBuffedEffect(SecondaryStat.AbyssalLightning) != null && player.getSkillCustomValue(400021113) == null)
      {
        ...
        player.getClient().getSession().writeAndFlush(CField.bonusAttackRequest(400021113, mobList, false, 0));
    ...
    else if (GameConstants.isWildHunter(player.getJob()))
    {
      ...
      if (attack.skill == 33121214 && player.getSkillCustomValue(33121214) == null)
      {
        ...
        List<MapleMapObject> objs = player.getMap().getMapObjectsInRange(player.getTruePosition(), 400000.0, Collections.singletonList(MapleMapObjectType.MONSTER));
        for (MapleMapObject m : player.getMap().getMapObjectsInRange(player.getTruePosition(), 400000.0, Collections.singletonList(MapleMapObjectType.MONSTER)))
        {
        ...
        if (!attackk.isEmpty())
        {
          ...
          {
            player.getClient().getSession().writeAndFlush(CField.rangeAttack(attack.skill, Collections.singletonList(new RangeAttack(33121019, m.getPosition(), 1, 0, 1))));
          }
    ...
    else if (GameConstants.isKadena(player.getJob()))
    {
      if (attack.skill == 64121020 && player.getSkillLevel(400041074) > 0)
      {
        ...
        player.getClient().getSession().writeAndFlush(CWvsContext.BuffPacket.giveBuff(statups, effect2, player));
        if (player.getSkillCustomValue0(400041074) > 0L && player.getSkillCustomValue0(64121020) >= (long) effect2.getW())
        {
          ...
          PlayerHandler.Vmatrixstackbuff(player.getClient(), true, null);
          player.getClient().getSession().writeAndFlush(CField.rangeAttack(400041074, Collections.singletonList(new RangeAttack(400041074, monster != null ? monster.getPosition() : attack.position, 0, 0, 5))));
        }
      }
    }
      ...
      if (player.getBuffedValue(400041052) && attack.targets != 0)
      {
        ...
        if (player.getInfinity() == 12)
        {
          for (MapleSummon summon5 : player.getSummons())
          {
            ...
            player.getClient().getSession().writeAndFlush(CField.SummonPacket.DeathAttack(summon5, Randomizer.rand(8, 10)));
            break;
          }
        }
      }
    ...
    else if (GameConstants.isArk(player.getJob()))
    {
      ...
      {
        player.getClient().getSession().writeAndFlush(CField.rangeAttack(attack.skill, Collections.singletonList(new RangeAttack(155101013, attack.position, 0, 0, 1))));
      }
      else if (attack.skill == 155101112)
      {
        player.getClient().getSession().writeAndFlush(CField.rangeAttack(attack.skill, Collections.singletonList(new RangeAttack(155101015, attack.position, 0, 0, 1))));
      }
      else if (attack.skill == 155121102)
      {
        player.getClient().getSession().writeAndFlush(CField.rangeAttack(attack.skill, Collections.singletonList(new RangeAttack(155121002, attack.position, 0, 0, 1))));
      }
    ...
    if (player.getSkillLevel(400041063) > 0 && attack.targets > 0 && !player.skillisCooling(400041067))
    {
      ...
      if (Arrays.asList(skills).contains(attack.skill))
      {
        ...
        Collections.addAll(sungi_skills);
        ...
        if (player.getBuffedEffect(SecondaryStat.SageElementalClone) != null && System.currentTimeMillis() - player.lastSungiAttackTime >= (long) (sungi.getV2() * 1000))
        {
          if (!sungi_skills.isEmpty())
          {
            ...
            while (m.hasNext())
            {
              ...
              player.getClient().getSession().writeAndFlush(CField.rangeAttack(sungi_skill, Collections.singletonList(new RangeAttack(sungi_skill, i == 0 ? pos : pos1, 1, 0, 1))));
              ++i;
            }
    ...
    if (attack.targets > 0 && player.getSkillCustomValue0(400031053) > 0L && player.getBuffedValue(400031053) && player.getSkillCustomValue(400031054) == null && !GameConstants.is_forceAtom_attack_skill(attack.skill))
    {
      ...
      player.getClient().getSession().writeAndFlush(CField.EffectPacket.showEffect(player, 0, 400031053, 10, 0, 0, (byte) (player.isFacingLeft() ? 1 : 0), true, player.getPosition(), null, null));
    ...
    if (attack.skill == 64001009 || attack.skill == 64001010 || attack.skill == 64001011 || attack.skill == 1100012 || attack.skill == 3111010 || attack.skill == 3211010)
    {
      ...
      {
        player.getClient().getSession().writeAndFlush(CField.EffectPacket.showEffect(player, attack.skill, attack.skill, 1, 0, monster != null ? monster.getObjectId() : 0, (byte) ((attack.facingleft >>> 4 & 0xF) == 8 ? 1 : 0), true, monster != null ? monster.getPosition() : attack.position, null, null));
      ...
      {
        player.getClient().getSession().writeAndFlush(CField.EffectPacket.showEffect(player, attack.skill, attack.skill, 1, 0, 0, (byte) ((attack.facingleft >>> 4 & 0xF) == 8 ? 1 : 0), true, attack.chain, null, null));
  ...
  public static final void applyAttackMagic (AttackInfo attack, Skill theSkill, MapleCharacter player, SecondaryStatEffect effect, double maxDamagePerHit)
  {
    ...
    if (totDamage > 0L)
    {
      ...
      if (GameConstants.isLuminous(player.getJob()))
      {
        ...
        if (player.getBuffedValue(400021105) && (GameConstants.isLightSkills(attack.skill) || attack.skill == 27121303 || GameConstants.isDarkSkills(attack.skill)) && player.getSkillLevel(400021105) > 0 && player.getSkillCustomValue(400021109) == null)
        {
          ...
          player.getClient().getSession().writeAndFlush(CField.rangeAttack(400021105, Collections.singletonList(new RangeAttack(skillid, attack.position, 1, 0, 1))));
        ...
        else if (!player.getBuffedValue(20040219) && !player.getBuffedValue(20040220))
        {
          if (player.getLuminusMorph())
          {
            if (GameConstants.isLightSkills(attack.skill))
            {
              if (!(player.getBuffedValue(20040219) || player.getBuffedValue(20040220) || player.getBuffedValue(400021105) || !GameConstants.isLightSkills(attack.skill) || player.getSkillLevel(400021105) <= 0 || player.skillisCooling(400021106)))
              {
                ...
                player.getClient().getSession().writeAndFlush(CField.rangeAttack(400021105, Collections.singletonList(new RangeAttack(400021107, attack.position, 1, 0, 1))));
                player.addCooldown(400021106, System.currentTimeMillis(), effect2.getX() * 1000L);
                player.getClient().getSession().writeAndFlush(CField.skillCooldown(400021106, effect2.getX() * 1000));
                HashMap<SecondaryStat, Pair<Integer, Integer>> statups = new HashMap<SecondaryStat, Pair<Integer, Integer>>();
          ...
          else if (GameConstants.isDarkSkills(attack.skill))
          {
            if (!player.getBuffedValue(400021105) && GameConstants.isDarkSkills(attack.skill) && player.getSkillLevel(400021105) > 0 && !player.skillisCooling(400021106))
            {
              ...
              player.getClient().getSession().writeAndFlush(CField.rangeAttack(400021105, Collections.singletonList(new RangeAttack(400021108, attack.position, 1, 0, 1))));
              player.addCooldown(400021106, System.currentTimeMillis(), effect2.getX() * 1000L);
              player.getClient().getSession().writeAndFlush(CField.skillCooldown(400021106, effect2.getX() * 1000));
              HashMap<SecondaryStat, Pair<Integer, Integer>> statups = new HashMap<SecondaryStat, Pair<Integer, Integer>>();
              statups.put(SecondaryStat.LiberationOrb, new Pair<Integer, Integer>(1, 0));
      ...
      else if (GameConstants.isLara(player.getJob()) && attack.targets > 0 && (attack.skill == 162001000 || attack.skill == 162121021))
      {
        ...
        {
          player.getClient().getSession().writeAndFlush(CField.rangeAttack(attack.skill, Collections.singletonList(new RangeAttack(162001004, attack.position, 0, 0, 1))));
        }
        if (player.getBuffedValue(162121003))
        {
          ...
          {
            player.getClient().getSession().writeAndFlush(CField.rangeAttack(162121004, Collections.singletonList(new RangeAttack(162121004, attack.position, 0, 0, 1))));
            player.setSkillCustomInfo(162121004, 0L, (int) effects.getT() * 1000L);
          }
        }
        if (player.getBuffedValue(162121006))
        {
          ...
          {
            player.getClient().getSession().writeAndFlush(CField.rangeAttack(162121007, Collections.singletonList(new RangeAttack(162121007, attack.position, 0, 0, 1))));
            player.setSkillCustomInfo(162121007, 0L, (int) effects.getT() * 1000L);
          }
        }
        if (player.getBuffedValue(162121009))
        {
          ...
          {
            player.getClient().getSession().writeAndFlush(CField.rangeAttack(162121010, Collections.singletonList(new RangeAttack(162121010, attack.position, 0, 0, 5))));
            player.setSkillCustomInfo(162121010, 0L, (int) effects.getT() * 1000L);
          }
        }
      }
      if (attack.targets > 0 && player.getBuffedEffect(SecondaryStat.Triumph) != null && attack.skill != 2311017 && System.currentTimeMillis() - player.TriumphTime >= 2000)
      {
        ...
        {
          final List<SecondAtom> atoms = new ArrayList<SecondAtom>();
          atoms.add(new SecondAtom(0x25, player.getId(), monster.getId(), 2311017, 4000, 0, 1, new Point((int) player.getTruePosition().getX(), (int) player.getTruePosition().getY() - 120), Collections.singletonList(0)));
          atoms.add(new SecondAtom(0x25, player.getId(), monster.getId(), 2311017, 4000, 0, 1, new Point((int) player.getTruePosition().getX() + 20, (int) player.getTruePosition().getY() - 116), Collections.singletonList(0)));
          atoms.add(new SecondAtom(0x25, player.getId(), monster.getId(), 2311017, 4000, 0, 1, new Point((int) player.getTruePosition().getX() - 20, (int) player.getTruePosition().getY() - 120), Collections.singletonList(0)));
          atoms.add(new SecondAtom(0x25, player.getId(), monster.getId(), 2311017, 4000, 0, 1, new Point((int) player.getTruePosition().getX() + 10, (int) player.getTruePosition().getY() - 116), Collections.singletonList(0)));
          atoms.add(new SecondAtom(0x25, player.getId(), monster.getId(), 2311017, 4000, 0, 1, new Point((int) player.getTruePosition().getX() - 10, (int) player.getTruePosition().getY() - 120), Collections.singletonList(0)));
          player.spawnSecondAtom(atoms);
    ...
    if (player.getBuffedValue(400021092) && player.getSkillCustomValue0(400021092) != 1L)
    {
      ...
      List<MapleMapObject> objs = player.getMap().getMapObjectsInRange(player.getTruePosition(), 800000.0, Collections.singletonList(MapleMapObjectType.MONSTER));
  ...
  public static final AttackInfo parseDmgM (LittleEndianAccessor lea, MapleCharacter chr, boolean dot)
  {
    ...
    try
    {
      ...
      ret.position = GameConstants.is_super_nova_skill(ret.skill) ? lea.readPos() : (lea.readPos());
