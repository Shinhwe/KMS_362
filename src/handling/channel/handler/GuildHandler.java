...
public class GuildHandler
{
  ...
  private static final Map<Integer, Long> request = new LinkedHashMap<>();
  ...
  public static final void GuildCancelRequest(LittleEndianAccessor slea, MapleClient c, MapleCharacter chr)
  {
    ...
    chr.setKeyValue(26015, "time", String.valueOf(System.currentTimeMillis()));
  ...
  public static void GuildBroadCast(byte[] packet, MapleGuild guild)
  {
    ...
    for (ChannelServer cs : ChannelServer.getAllInstances())
    {
      ...
      {
        /* 709 */
        if (chr.getGuildId() == guild.getId()) /* 710 */
        {
