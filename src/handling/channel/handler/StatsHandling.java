...
public class StatsHandling
{
    ...
    if (chr.getRemainingAp() > 0)
    {
      switch (slea.readInt())
      {
        ...
        case 2048:
        {
          ...
          maxhp = GameConstants.isBeginnerJob(job) ? (maxhp += Randomizer.rand(8, 12)) : (job >= 100 && job <= 132 || job >= 3200 && job <= 3212 || job >= 1100 && job <= 1112 || job >= 3100 && job <= 3112 ? (maxhp += Randomizer.rand(36, 42)) : (job >= 200 && job <= 232 || GameConstants.isEvan(job) ? (maxhp += Randomizer.rand(10, 20)) : (job >= 300 && job <= 322 || job >= 400 && job <= 434 || job >= 1300 && job <= 1312 || job >= 1400 && job <= 1412 || job >= 3300 && job <= 3312 || job >= 2300 && job <= 2312 ? (maxhp += Randomizer.rand(16, 20)) : (job >= 510 && job <= 512 || job >= 1510 && job <= 1512 ? (maxhp += Randomizer.rand(28, 32)) : (job >= 500 && job <= 532 || job >= 3500 && job <= 3512 || job == 1500 ? (maxhp += Randomizer.rand(18, 22)) : (job >= 1200 && job <= 1212 ? (maxhp += Randomizer.rand(15, 21)) : (job >= 2000 && job <= 2112 ? (maxhp += Randomizer.rand(38, 42)) : (maxhp += Randomizer.rand(50, 100)))))))));
        ...
        case 8192:
        {
          ...
          else
          {
            ...
            maxmp = job >= 200 && job <= 232 || GameConstants.isEvan(job) || job >= 3200 && job <= 3212 || job >= 1200 && job <= 1212 ? (maxmp += Randomizer.rand(38, 40)) : (job >= 300 && job <= 322 || job >= 400 && job <= 434 || job >= 500 && job <= 532 || job >= 3200 && job <= 3212 || job >= 3500 && job <= 3512 || job >= 1300 && job <= 1312 || job >= 1400 && job <= 1412 || job >= 1500 && job <= 1512 || job >= 2300 && job <= 2312 ? (maxmp += Randomizer.rand(10, 12)) : (job >= 100 && job <= 132 || job >= 1100 && job <= 1112 || job >= 2000 && job <= 2112 ? (maxmp += Randomizer.rand(6, 9)) : (maxmp += Randomizer.rand(50, 100))));
          }
  ...
  public static final void DistributeSP(int skillid, int count, MapleClient c, MapleCharacter chr)
  {
    ...
    {
      int left;
      if (!(ski.left.equals("level") ? chr.getLevel() < ski.right : chr.getSkillLevel(SkillFactory.getSkill(left = Integer.parseInt(ski.left))) < ski.right))
      {
        continue;
      }
      return;
