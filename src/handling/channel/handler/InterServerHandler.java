    ...
    try
    {
      ...
      if (player.getClient().getKeyValue("BloomingTuto") != null)
      {
        ...
        if (player.getClient().getKeyValue("BloomingSkill") != null)
        {
          ...
          {
            /*  367 */
            player.setKeyValue(501378, String.valueOf(a), ab[a]);
            /*  368 */
      ...
      {
        int questid = iterator.next().intValue();
        /*  421 */
        if (player.getQuestStatus(questid) != 2)
        {
          /*  422 */
      ...
      if (itemexppendent)
      {
        ...
        else
        {
          ...
          /*  835 */
          player.setKeyValue(27040, "firstequiptimemil", String.valueOf(System.currentTimeMillis()));
          /*  836 */
          player.setKeyValue(27040, "equipday", String.valueOf(kc.getDayt()));
          /*  837 */
          player.setKeyValue(27040, "equipmonth", String.valueOf(kc.getMonth()));
          /*  838 */
      ...
      if (player.getClient().getKeyValue("presetNo") != null)
      {
        ...
        /*  918 */
        if (preset != player.getKeyValue(500630, "presetNo")) /*  919 */
        {
          player.setKeyValue(500630, "presetNo", String.valueOf(preset));
        }
      }
      int i;
      /*  922 */
      ...
      for (i = 0; i < 8; i++)
      {
        ...
        /*  933 */
        if (player.getKeyValue(18791, String.valueOf(i)) == -1L && player.getClient().getCustomData(id, String.valueOf(i)) != null)
        {
          /*  934 */
      ...
      {
        /* 1229 */
        if (player.getKeyValue(100794, "point") < 0L)
        {
          /* 1230 */
          player.setKeyValue(100790, "lv", "1");
          /* 1231 */
          player.setKeyValue(100794, "point", "0");
          /* 1232 */
          player.setKeyValue(100794, "sum", "0");
          /* 1233 */
          player.setKeyValue(100794, "date", kc.getYears() + kc.getMonths() + kc.getDays());
          /* 1234 */
          player.setKeyValue(100794, "today", "0");
        }
        /* 1236 */
      ...
      player.changeSkillLevel(SkillFactory.getSkill(80000186), 1, 1);
      player.changeSkillLevel(SkillFactory.getSkill(80000187), player.getLevel(), player.getLevel());
      /* 1283 */
    }
    catch (Exception e)
    {
