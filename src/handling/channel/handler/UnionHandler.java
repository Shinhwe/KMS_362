...
public class UnionHandler
{
  ...
  public static void setUnion(final LittleEndianAccessor slea, final MapleClient c)
  {
    try
    {
      ...
      c.getPlayer().setKeyValue(500630, "presetNo", String.valueOf(priset));
      c.setKeyValue("presetNo", String.valueOf(priset));
      for (int batch = slea.readInt(), i = 0; i < batch; ++i)
      {
        final int t = slea.readInt();
        c.getPlayer().setKeyValue(18791, String.valueOf(i), String.valueOf(t));
        c.setCustomData(500627 + priset, String.valueOf(i), String.valueOf(t));
      }
