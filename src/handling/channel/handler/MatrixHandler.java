  ...
  public static void updateCore (final LittleEndianAccessor slea, final MapleClient c)
  {
    ...
    switch (state)
    {
      ...
      case 4:
      {
        ...
        c.getSession().writeAndFlush(CWvsContext.OnCoreEnforcementResult(target, exp, prevLevel, core3.getLevel()));
        break;
      }
      case 5:
      {
      ...
      case 6:
      {
        ...
        c.getPlayer().getCore().removeAll(removes);
        calcSkillLevel(c.getPlayer(), 5);
        c.getSession().writeAndFlush(CWvsContext.DeleteCore(count2));
        break;
      }
      case 7:
      {
