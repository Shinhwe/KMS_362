...
public class CharacterTransfer implements Externalizable
{
  ...
  public CharacterTransfer(MapleCharacter chr)
  {
    ...
    {
      this.Quest.put(Integer.valueOf(qs.getKey().getId()), qs.getValue());
    }
    this.inventorys = chr.getInventorys();
    for (Map.Entry<Skill, SkillEntry> qs : chr.getSkills().entrySet())
    {
      this.Skills.put(Integer.valueOf(qs.getKey().getId()), qs.getValue());
    }
  ...
  public void writeExternal(ObjectOutput out) throws IOException
  {
    ...
    {
      out.writeInt(qs.getKey().intValue());
    ...
    {
      out.writeInt(cv.getKey().intValue());
      out.writeInt(cv.getValue().intValue());
    }
    ...
    for (Map.Entry<CharacterNameAndId, Boolean> qs : this.buddies.entrySet())
    {
      ...
      out.writeBoolean(qs.getValue().booleanValue());
    ...
    {
      out.writeByte(ss.getKey().byteValue());
      out.writeInt(ss.getValue().intValue());
    }
    ...
    {
      out.writeInt(qs.getKey().intValue());
      out.writeByte(qs.getValue().left.byteValue());
      out.writeInt(qs.getValue().right.intValue());
    }
    ...
    for (Map.Entry<MapleTrait.MapleTraitType, Integer> ts : this.traits.entrySet())
    {
      ...
      out.writeInt(ts.getValue().intValue());
    }
