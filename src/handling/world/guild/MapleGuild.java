...
public class MapleGuild implements Comparable<MapleGuild>
{
  ...
  public final void changeRankRole(MapleCharacter chr, int[] roles)
  {
    ...
    /* 1174 */
    /* 1175 */
    System.arraycopy(roles, 0, this.rankRoles, 0, 5);
    /* 1177 */
    updateRankRole();
    /* 1178 */
  ...
  public final void gainGP(int amount, boolean broadcast, int cid)
  {
    ...
    {
      /* 1401 */
      chr.setKeyValue(210302, "GP", String.valueOf(chr.getKeyValue(210302, "GP") + amount));
    }
    else
    {
      return;
  ...
  public int getSkillLevel(int sid)
  {
    ...
    /* 1443 */
    return this.guildSkills.get(Integer.valueOf(sid)).level;
  }
  ...
  {
    /* 1838 */
    if (getGuildScore() < o.getGuildScore()) /* 1839 */
    {
      return 1;
    }
    /* 1840 */
