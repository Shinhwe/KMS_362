...
//    System.out.println(header.getValue());
    ...
    switch (header)
    {
      ...
      {
        InventoryHandler.blackFlameResult(slea, c);
        break;
      }
      case QUICK_PASS:
      {
      ...
      case START_QUEST:
      {
        ...
        slea.skip(4);
        c.getPlayer().setKeyValue(questid, "start", String.valueOf(types));
        c.getPlayer().setKeyValue(questid, "NpcSpeech", npcid + String.valueOf(types));
