    ...
    switch (op)
    {
      ...
      case 0:
        ...
        for (Map.Entry<Integer, AuctionItem> itemz : items.entrySet())
        {
          ...
          {
            int auctionId = iterator1.next().intValue();
            /*  154 */
          ...
          if (searchType <= 1)
          {
            ...
            for (AuctionItem auctionItem : items.values())
            {
              ...
              if (auctionItem.getItem() != null && auctionItem.getItem().getType() == 1)
              {
                ...
                /*  805 */
                boolean potentialLimit = false; // (potentialType == -1 || (potentialType == 0 && equip.獲取附加潛能等級() == 裝備潛能等級.沒有潛能) || (potentialType > 0 && equip.獲取附加潛能等級().獲取潛能等級的值() - 16 == potentialType));
                /*  806 */
