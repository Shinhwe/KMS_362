...
function action(mode, type, selection) {
	...
	if (cm.getClient().getKeyValue(20190324, "sorry") == -1) {
	   cm.sendYesNo("#fs14#최근 잦은 점검 및 서버 초기화로 인해 불편을 겪으신 유저분들께 작은 보상을 마련하였습니다. 지금 상자를 여셔서 보상을 획득하시겠습니까?\r\n\r\n"
		+"#r#e(#fs14#점검 보상 상자는 계정당 1회만 사용하실 수 있으니 신중히 사용해 주세요.)#k#n");
        } else {
	   cm.sendOk("#fs14#점검 보상 상자는 계정당 1회만 사용하실 수 있습니다.");
	   cm.dispose();
	   return;
	}
    } else if (status == 1) {
	talk = "#fs14#아래와 같은 아이템을 획득하셨습니다.\r\n\r\n"
