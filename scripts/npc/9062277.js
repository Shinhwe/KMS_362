...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        choose += "#fs14##L0##fc0xFF6B66FF#" + 강화 + " 강화 아이템 상점#l";
        ...
        sel = selection;
        if (selection == 0) {
            말 = "#fs14#" + 검정 + "어떤 상점을 이용할지 골라보게.\r\n"
            말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
            말 += "#fs14##fc0xFF6B66FF##L0#" + 강화 + " 메소로 강화아이템#k" + 검정 + "을 구매하고 싶습니다.\r\n"
            말 += "#fs14##fc0xFFFF5AD9##L1#" + 분홍콩 + " 분홍콩으로 강화아이템#k" + 검정 + "을 구매하고 싶습니다.\r\n"
            cm.sendSimpleS(말, 0x04, 9062277)
        } else if (selection == 1) {
            cm.dispose();
            cm.openShop(1);
        } else if (selection == 2) {
            cm.sendYesNoS("#fs14##b페스티벌#k#fc0xFF191919#을 혼자 즐기기엔 쓸쓸한 모양이군!\r\n내가 준비한 아이들이 많으니 #r캐시샵#k#fc0xFF191919#에서 천천히 둘러보게나\r\n\r\n물론 #b무료#k#fc0xFF191919#로 분양하니 걱정말게.\r\n\r\n#r캐시샵#k #fc0xFF191919#입장을 원하시면 #r예#k #fc0xFF191919#버튼을 눌려주세요.", 0x04, 9062277);
        } else if (selection == 3) {
            cm.dispose();
            cm.openShop(2);
        } else if (selection == 4) {
            ...
            말 = "#fs14##L20#" + 분홍콩 + " " + 분홍 + "분홍콩 상점#k" + 검정 + "을 이용하고 싶습니다.#l\r\n";
            ...
            말 = "#fs14#" + 검정 + "#b블랙 이벤트#k" + 검정 + "로 다양한 아이템이 있는 상점이 개봉되었다네! 원하는걸 선택해보게나! 크크.\r\n"
            말 += "#fc0xFFD5D5D5#───────────────────────────#k#l\r\n";
            말 += "#fs14##L19##fc0xFF00B700#블랙 스타 코인 상점#k을 이용하고 싶습니다.#l\r\n";
        ...
        if (selection == 0) {
            ...
            말 = "#fs14##b블랙 잠수 포인트#k" + 검정 + " 획득 방법에 대해 알려주겠네.\r\n\r\n"
