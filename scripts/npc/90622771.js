...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		msg +="#L1##fs14##fUI/Basic.img/BtCoin/normal/0##fc0xFFFF3300# 소비상점#l"+space+"#fc0xFF000099##L6#"+icon+"100711/iconShop# 네오스톤#l"+space+"#L11#"+icon+"501053/iconShop##fc0xFFFF3366# 도네이션 (후원)#l\r\n";
