...
function action(mode, type, selection) {
	...
	for (i = 0; i < cm.getInventory(1).getSlotLimit(); i++) {
		...
		if (cm.getInventory(1).getItem(i).getStarForceLevel() >= 25 || (cm.getInventory(1).getItem(i).getStarForceLevel() >= 15 && cm.getInventory(1).getItem(i).isAmazingequipscroll())) {
