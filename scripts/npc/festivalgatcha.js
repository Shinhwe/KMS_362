...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        말 = "#fs14#타르르르륵··· #d오색빛깔 부우 룰렛#k이 쌓여있다.\r\n"
        말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        ...
        if (selection == 0) {
            if (!cm.haveItem(4310013, 1)) {
                cm.sendOkS("#fs14#룰렛을 이용하기 위한 티켓이 부족하다..", 0x04, 9401420);
                cm.dispose();
                return;
            }
            ...
            if (leftslot < 2 && leftslot1 < 2 && leftslot2 < 2 && leftslot3 < 2 && leftslot4 < 2 && leftslot5 < 2) {
               cm.sendOkS("#fs14#모든 인벤토리창 2칸 이상을 비워야 한다..", 0x04, 9401420);
               cm.dispose();
               return;
            }
            ...
            cm.sendOkS("#fs14##i"+itemid+"# #z"+itemid+"# "+count+"개", 0x04, 9401420);
            cm.gainItem(4310013, -1);
            cm.dispose();
        } else if (selection == 1) {
            말 = "#fs14#룰렛 아이템 리스트 입니다.\r\n\r\n"
