...
/*
				var msg = "";
				msg += "#L1##fs14##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/23# #d레벨 랭킹"+enter;
				msg += "#L2##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/23# 메소 랭킹"+enter;
				msg += "#L3##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/23# 데미지 측정랭킹"+enter;
				msg += "#L4##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/23# 길드 랭킹"+enter;
				msg += "#L5##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/23# 무릉도장 랭킹"+enter;
				cm.sendSimple(msg);
*/
				cm.dispose();
				cm.openNpc(2040050);
