...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg ="#fs14##d현재 #h #님의 후원포인트 : #r"+cm.getPlayer().getDonationPoint()+"P#b"+enter;
		...
		switch (sel) {
			...
			break;
			case 2:
				var msg = "#fn나눔고딕 ExtraBold##fs15#후원 스페셜 스킬 목록#Cgray# #fs14##r(Special Skill)#k#fs14#"+enter;
			...
			case 3:
				...
				var msg = "원하는걸 골라보거라#fs14##b"+enter;
			...
			return;
                        case 9:
				var msg = "#fn나눔고딕 ExtraBold##fs15#후원 VIP 스킬 제작#Cgray# #fs14##r(VIP Skill)#k#fs14#"+enter;
		...
		switch (seld) {
			case 1:
				...
				if (selditem['t'].equals("stat")) {
					...
					msg += "#fs14#가격은 #b"+selditem['price']+"P#k이고 현재 #b#h #님의 "+sad+"포인트는 "+p+"P#k입니다."+enter;
					msg += "몇 개 구매하시겠습니까?";
					cm.sendGetNumber(msg, 1, 1, 100);
				}
			break;
		...
		switch (seld) {
			case 1:
				...
				if (selditem['t'].equals("item")) {
					...
					msg += "#fs14#가격은 #b"+(selditem['price'] * seldq)+"P#k이고 현재 #b#h #님의 "+sad+"포인트는 "+p+"P#k입니다."+enter;
					msg += "정말 구매하시겠습니까?";
					cm.sendYesNo(msg);
				} else {
					seldq = sel;
