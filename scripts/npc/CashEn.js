...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var txt = "#fs14##fc0xFF000000#캐시아이템을 #b#z4310308# 30개#fc0xFF000000#로 강화할 수 있다는 사실을 알고 계시나요? #b원하시는 캐시아이템#fc0xFF000000#을 골라주세요.\r\n#r(1회당 올스탯 2 / 공 마 2 증가 중첩가능)#k\r\n";
		...
		if (!cm.haveItem(4310308, 30)) {
			cm.sendOk("#fs14##fc0xFF000000#1회 강화하기 위해선 #b" + price + " #z4310308##fc0xFF000000#가 필요합니다.");
			cm.dispose();
			return;
		}
		...
		cm.sendOk("#fs14#아이템에 스텟을 부여했습니다. 이용해 주셔서 감사합니다.");
		cm.dispose();
