		...
		if(rotation != -1)
		{
			...
			inz.setArc(3000);
				switch(S3)
				{
					...
					case 29: inz.setStarForceLevel(S4); break;
					...
					case 36: inz.設置潛能等級(S4); break;
					case 37: inz.設置第一條主潛能(S4); break;
					case 38: inz.設置第二條主潛能(S4); break;
					case 39: inz.設置第三條主潛能(S4); break;
					case 40: inz.設置第一條附加潛能(S4); break;
					case 41: inz.設置第二條附加潛能(S4); break;
					case 42: inz.設置第三條附加潛能(S4); break;
