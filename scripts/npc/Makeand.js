...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "#fs14#안드로이드를 제작할 수 있는 레시피가 적힌 도감이다.#k#n"+enter;
      msg += "";
      for (i = 0; i < items.length; i++)
         msg += "#fs14##b#L"+i+"##i"+items[i]['itemid']+"##z"+items[i]['itemid']+"# "+items[i]['qty']+"개#k"+enter;
      ...
      var msg = "#fs14#선택한 아이템은 다음과 같다.#fs14##b"+enter;
      msg += "#fs14#아이템 : #i"+item['itemid']+"##z"+item['itemid']+"# "+item['qty']+"개"+enter;
      ...
      msg += enter;
      msg += "#fs14##k선택한 아이템을 제작하기 위한 레시피, #fs14# #b제작 확률은 50%#k\r\n제작 실패시 #b#i4001715##z4001715##k 지급#d"+enter+enter;
