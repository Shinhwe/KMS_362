...
function getList() {
        	...
        	if (ret.equals("")) return "#fs14#현재 수령 가능한 후원 보상이 없습니다.";
        	return ret;
}
function getListAdmin() {
        	...
        	if (ret.equals("")) return "#fs14#문제가 발생했습니다.";
        	return ret;
}

function getList2Admin(n) {
	var mine = false;
	var ret = "#fs14#어떤 보상을 삭제하시겠어요? (처리 안된 보상만 보입니다.) \r\n----------------------------------------------\r\n";
	var con = DatabaseConnection.getConnection();
