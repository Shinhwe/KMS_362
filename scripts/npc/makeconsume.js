...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "#fs14#소비 아이템을 제작 하고싶으신가요?#k#n"+enter;
      msg += "";
      ...
      var msg = "#fs14#선택한 아이템은 다음과 같습니다.#fs14##b"+enter;
      ...
      msg += enter;
      msg += "#fs14##k선택한 아이템을 제작하기 위한 레시피입니다.#fs14##d"+enter+enter;
