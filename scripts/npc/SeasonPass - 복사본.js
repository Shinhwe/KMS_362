...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	var msg = "#fs14##fc0xFF000000#    현재 #fc0xFF6600CC##h0# #fc0xFF000000#님의 성장패스 레벨 :#fc0xFFFF3300# " + cm.getPlayer().getKeyValue(100592, "point") + "\r\n";
	msg += "#Cgray#――――――――――――――――――――――――――――――――――――――――";
	...
	if (selection == 1) {
		var list = "#fs14##fc0xFF000000#자네가 받을 수 있는 보상은 아래와 같다네.#b\r\n";
		...
		if (mine.length > 0) {
			...
			cm.sendOk("#fs14##fc0xFF000000#받을 수 있는 보상이 없다네.");
			cm.dispose();
			return;
		}
	} else if (selection == 2) {
