...
function action(mode, type, selection) {
    if (mode == -1 || mode == 0) {
        if (status == 2 && sel == 4) {//승급 거부
            cm.sendOkS("#fs14#그래! 마음이 바뀌면 다시 돌아오게나!", 0x04, 9401232);
        }
        cm.dispose();
        return;
    }
	...
	for (var i = 60000; i < 60015; i++) {
        ...
        var choose = "#fn나눔고딕#Happy ! 컨텐츠 관련 NPC입니다.#fs14#\r\n";
        choose += "#fn나눔고딕##fs14##L0#" + 의자 + " #fc0xFFF15F5F#의자 뽑기#l#k　";
        ...
        if (selection == 0) {
            ...
            말 = "#fs14#" + 검정 + "어서오게! #b페스티벌#k" + 검정 + "은 재밌게 즐기고 있나? 더 재밌게 즐기기 위한 #r승급제도#k" + 검정 + "가 있다네. 자네도 한번 해볼텐가?\r\n";
            말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
            ...
            var choose = "#fs14#" + 검정 + "초월자의 힘에 다가가 볼텐가?\r\n";
...
cm.openNpc(9062147);
            ...
            var choose = "#fs14#" + 검정 + "자네를 위해 다양한 퀘스트가 준비되어 있다네!\r\n";
            choose += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
...
cm.openNpc(9062296);
        ...
        if (sel == 4) {// 칭호 승급
            if (selection == 3) {
                ...
                말 = "#fs14#칭호 승급을 하기 위해선 아래의 조건이 필요하다네.\r\n"
                말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
                selching = selection;
                if (selching == 0) {
                    ssssitem = 4310012;
            ...
            if (selection == 5) {
                말 = "#fs14##i1182000# #b#z1182000##k 아이템을 제작하겠나?"
            ...
            if (selection == 22) {
                ...
                말 = "#fs14#" + 검정 + "페스티벌에서 다양한 점프맵도 준비해봤다네!\r\n"
                말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        ...
        if (selection == 100) {
            ...
            if (leftslot < 2) {
                cm.sendOkS("#fs14##r기타칸 2 칸 이상을 확보하고 다시 말을 걸어주게.", 0x04, 9401232);
                cm.dispose();
                return;
            }
            if (cm.getPlayer().getLevel() < 230) {
                cm.sendOkS("#fs14##r레벨 230 이상이 되어야 승급이 가능하다네.", 0x4, 9401232);
                cm.dispose();
                return;
            }
            if (cm.getPlayer().getMeso() < ssssitemmeso || !cm.haveItem(ssssitem2, ssssitemc2) || !cm.haveItem(ssssitem, ssssitemc)) {   //재료체크
                cm.sendOkS("#fs14##r승급에 필요한 재료가 부족한거 같네.", 0x04, 9401232);
                cm.dispose();
                return;
            }
            ...
            if (sell == 5) {
                if (cm.getPlayer().getMeso() < 700000000 || !cm.haveItem(4310010, 50)) {   //재료체크
                    cm.sendOkS("#fs14##b#z1182000##k를 제작하기 위한 재료 아이템이 부족한거 같군.", 0x04, 9401232);
                    cm.dispose();
                    return;
                }
                ...
                if (Math.floor(Math.random() * 100) <= 50) {// 성공했을때
                    ...
                    cm.gainItem(4310010, -50);
                    cm.getPlayer().AddBloomingCoin(-350, null);
                    cm.sendOkS("#fs14##r아쉽게도 제작에 실패했다네..", 0x04, 9401232);
                    cm.dispose();
                    return;
                }
            } else if (sell == 6) {
                ...
                if (selection == 1) {
                    suc = 5;
                    말 = "#fs14##i1162000# #b#z1162000##k 아이템을 제작하겠나?"
                    말 += "\r\n제작을 하려면 아래의 재료가 필요하지.\r\n"
                    ...
                    suc = 30;
                    말 = "#fs14##i1162002# #b#z1162002##k 아이템을 제작하겠나?"
                    말 += "\r\n제작을 하려면 아래의 재료가 필요하지.\r\n"
                    말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        ...
        if (sel == 5) {
            ...
            if (!cm.haveItem(needitem1, needitem1count)) {   //재료체크
                cm.sendOkS("#fs14##b#z" + sucitemid + "##k를 제작하기 위한 재료 아이템이 부족한거 같군.", 0x04, 9401232);
                cm.dispose();
                return;
            }
            ...
            if (Randomizer.isSuccess(suc)) {// 성공했을때
                ...
                txt = "";
                if (sel2 == 1) {
                    txt += "#fs14##r아쉽게도 제작에 실패했다네..";
                } else {
                    txt += "#fs14#아쉽게도 합성에 실패했다네..\r\n\r\n"
        ...
        if (sel == 4) {//승급 연출
            ...
            if (succ) {
                ...
                cm.gainMeso(-meso);
                말 = "#fs14#블랙 페스티벌에서의 승급을 축하한다네!\r\n\r\n"
                말 += "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n"
                말 += "#i" + rewarditemid + "##b#z" + rewarditemid + "##k";
                cm.sendOkS(말, 0x04, 9401232);
                cm.dispose();
            } else {
                말 = "#fs14#너무 상심하지 말게 #h #.. 다음엔 좋은 결과가 있을거라네..!\r\n\r\n"
                cm.gainItem(etc, -sale);
                cm.gainItem(etc1, -sale1);
                cm.gainMeso(-meso);
                cm.sendOkS(말, 0x04, 9401232);
