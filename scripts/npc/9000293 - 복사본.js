...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#fs14#점프에 자신이 있는거야? #b퀘스트는 마을에서만 수행 가능하니 유의해줘!#k\r\n\r\n";
		//msg += "#L1#유니온";
		...
		switch (sel) {
			case 1:
				var msg = "";
				msg += "#L1##fUI/UIWindow6.img/attackerSetting/Board/sector/char_main/3/0##fs14# #d 메이플 유니온(Union) #r업무 "+enter+enter;
			...
			break;
                        case 7:
				var msg = "#fs14#인내심을 테스트해보고싶으신가요?\r\n#b점프맵#k을 클리어해 보상을 받아보세요!"+enter;
				msg += "#fs14##fUI/UIWindow8.img/EldaGauge/tooltip/23##d 존 클리어";
				msg += "#L1##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/23##d 인내의 숲"+enter;
				msg += "#L2##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/24# 끈기의 숲"+enter;
				msg += "#L3##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/25# 고지를 향해서"+enter;
				msg += "#L4##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/26# 펫 산책로 (헤네시스)"+enter;
				msg += "#L5##fs14##fUI/UIWindow8.img/EldaGauge/tooltip/27# 펫 산책로 (루디브리엄)"+enter;
				cm.sendSimple(msg);
			break;
                        case 8:
				var msg = "";
