...
function action(mode, type, selection) {     
    ...
    if (status == 0) {
        ...
        //if (gK() <= 0) { sK(1); }
        말 = "#fs14##fc0xFF990033##e보스랭크 승급 시스템#n#fc0xFF000000#이라네\r\n#b보스랭크 승급#fc0xFF000000#을 통해 더욱 더 강해져보지 않겠나!?\r\n\r\n"
        말+= "#L0##b"+(gK() + 1)+"레벨로 승급하겠습니다.#l\r\n";
        말+= "#L1##b보스랭크란 무엇인가요?#l"
        cm.sendSimple(말);
    } else if (status == 1) { 
        if (selection == 0) {
            말 = (gK() + 1) + "#fs14#레벨로 레벨업을 하기 위해선 아래와 같은 재료가 필요하다네.\r\n\r\n"
