...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		msg += "#L1##fs14##d아이템 목록을 확인해본다."+enter;
		msg += "#L2#랜덤으로 뽑아볼래.\r\n";
		//msg += "#L3#선택 박스를 개봉할래요!";
		...
		switch (sel) {
			...
			case 2:
				...
				cm.sendOk("#fs14#다음과 같은 아이템이 나왔다. #fs14##b"+enter+"#i"+dskin[a]+"##z"+dskin[a]+"#");
				cm.dispose();
			break;
			case 3:
				var msg = "원하시는 라이딩을 선택해주세요. #fs14##b"+enter;
