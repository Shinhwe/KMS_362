...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var text = ""
            text = "#fs14#" + 검정 + "저는 #fc0xFF000087#[블랙]#k " + 검정 + "컨텐츠 부서에서 #b라이딩 뽑기#k" + 검정 + "를 담당하고 있는 포밍이라고 합니다."
            ...
            if (selection == 12) {
                var amed = "#fs14##fc0xFB1B66FF#라이딩 리스트#k\r\n\r\n";
                ...
                if (!cm.haveItem(4310012, 65)) {
		            cm.sendOk("#fs14##i4310012# #b#z4310012##k 아이템이 부족하거나 없는거 같네요.");
                    cm.dispose();
                } else {
                    cm.sendYesNo("#fs14#정말로 #b라이딩#k을 뽑으시겠습니까?\r\n뽑기 진행 시 #r#z4310012# 65개#k가 소모됩니다.");
                }
            }
        } else if (status == 2) {
            switch (item) {
                case 0:
                    ...
                    if (cm.canHold(라이딩)) {
                        ...
                        말 = "#fs14#축하드려요 #b#h ##k님! 원하시던 라이딩은 나오셨나요? 마음에 들지 않는다면 한번 더 뽑아보시는건 어떨까요?\r\n\r\n"
                        말 += "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n"
                        말 += "#i" + 라이딩 + "# #b#z" + 라이딩 + "##k\r\n\r\n"
                        말 += "#L0##fc0xFF3B36CF#한번 더 뽑고 싶습니다.\r\n#L1#대화창 닫기"
                        cm.sendOk(말);
                    } else {
                        cm.sendOk("#fs14#라이딩을 받기 위한 공간이 부족한거 같네요.");
                        cm.dispose();
                    }
                    break;
            } 
