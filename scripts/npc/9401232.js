...
퀘스트 = "#fs14##fUI/UIWindow2.img/Quest/icon/iconInfo#";
가이드 = "#fs14##fUI/Basic.img/theblackcoin/26#";
var status = -1;
var seld = 0;
function start() {
    action(1, 0, 0);
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        seld = selection;
        if (selection == 0) {
            말 = "#fs14##b블랙 페스티벌#k에 온 #e#h ##n용사여, 어떤게 궁금한가?#k\r\n"
            말 += "#fc0xFFD5D5D5#─────────────────────────────#k#l\r\n";
            말 += "#L0##fs14##b블랙 배율에 대해서 궁금해요.\r\n"
            말 += "#L1#기본적인 규칙에 대해 알려주세요.\r\n\r\n"
            말 += "#L2##r대화 그만하기"
            cm.sendOkS(말, 0x04);
        } else if (selection == 1) {
            if (cm.haveItem(3700900, 1)) {
                cm.sendOk("#fs14#" + 검정 + "흠, 자네는 이미 칭호를 가지고 있는것 같네. 만약 잃어버린다면 다시 지급해주도록 하겠네!");
                cm.dispose();
                return;
            }
            var choose = "#fs14#"+검정+" 칭호를 지급 했다네. 더 좋은 칭호를 얻기 위해 #fc0xFF050099#블랙 페스티벌#k"+검정+"에서 열심히 즐겨보게나!\r\n";
            ...
            var choose = "#fs14#"+검정+"#b블랙 페스티벌#k"+검정+"에서 느낀 즐거움을 다른 사람에게도 나눠주게!\r\n";
        ...
        if (selection == 0) {
            ...
            말 ="#fs14#"+보라+"추천인 시스템"+검정+"에 대해 알려주겠네.\r\n\r\n"
