...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	var txt = "#fs14#안녕하세요 #b#h 0##k님! 뱃지, 엠블렘, 보조무기(블레이드 제외)의 기본 옵션 재설정이 가능하다는 사실을 알고 계시나요? 강화 시 #b각 스탯당 최대 30~150, HP는 10000, 공격력/마력은 150#k까지 부여될 수 있습니다. 옵션을 재설정할 아이템을 골라주세요.\r\n";
