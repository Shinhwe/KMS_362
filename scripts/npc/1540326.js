...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        말 = "             #fs14##d 해피스토리 스페셜 가챠 뽑기 \r\n#fs14##Cgray#  당신의 운을 믿고 확률을 걸어 좋은 아이템을 얻어보세요!#k\r\n\r\n#fs14#";
        ...
        if (selection == 0) {
            말 = "#fs14# #fc0xFF000000# 소비할 #b#z" + ccoin + "##k#fs14# #fc0xFF000000# 의 개수를 설정해 주세요.\r\n\r\n"
            ...
            말 = "#fs14##d#i4033114# 의 시스템은 기본적으로 #b" + itemlist.length + "단계#k#fs14# #d로 나뉘어져 있습니다.\r\n\r\n"
            ...
            말 = "#fs14##d 각 등급별 등장 가능한 아이템과 확률입니다.\r\n"
            말 += " #r (각 확률은 소숫점을 표시하지 않습니다.)#k\r\n"
            for (i = 0; i < itemlist.length; i++) {
                말 += "\r\n#fs15##r[" + name[i] + " 등급]#k#fs14##n\r\n"
        ...
        if (cm.itemQuantity(ccoin) < selection) {
            cm.sendOk("#fs14##fc0xFF000000#오류가 발생하였습니다.");
            cm.dispose();
            return;
        }
        st = selection;
        geti = Math.floor(selection / 100);
        말 = "#fs14##fc0xFF000000##i" + ccoin + "# #b#z" + ccoin + "##r " + st + "#k#fc0xFF000000#개를 사용하여\r\n 얻을 수 있는 아이템 리스트는 아래와 같습니다\r\n\r\n"
        ...
        말 = "#fs14##fc0xFF000000# 확률이 증가되어 재설정된 아이템 리스트입니다.\r\n\r\n";
        ...
        cm.sendYesNo("#fs14##fc0xFF000000#아래와 같은 아이템을 획득하였습니다.\r\n\r\n"
