...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        txt = "#fs14##b각종 스탯의 랭크#fc0xFF000000#를 올릴 수 있는 시스템이라네 원하는 항목을 골라보게나#n#k\r\n\r\n#b"
        txt += "#L0# 데미지 랭크\r\n"
        //txt += "#L1# 경험치 랭크\r\n"
        //txt += "#L2#드롭 티어\r\n"
        //txt += "#L3# 크리 데미지 랭크\r\n"
        ...
        if (sel == 0) {
            ...
            txt = "#fs14##b현재 나의 데미지 랭크#fc0xFF000000# #e[" + mytear + "랭크]#n\r\n"
            ...
            txt = "#fs14##b현재 나의 크리데미지 랭크#k #e[" + mytear + "랭크]#n\r\n"
            ...
            txt = "#fs14##b현재 나의 보스 공격력 랭크#k #e[" + mytear + "랭크]#n\r\n"
            txt += "#b다음 승급 랭크 #k#e[" + uptear + "랭크]#n\r\n"
            txt += "#b승급 가능한 최대 랭크는#k #e[8랭크]#n\r\n"
            txt += "승급한 랭크의 효과와\r\n승급에 필요한 #r아이템#k은 다음과 같습니다\r\n\r\n";
            txt += "#r#e승급 성공시 총 " + effect + " + #r#e" + up + "%#k\r\n#n#k #i" + needcoin + "# #b#z" + needcoin + "# " + needcoincount + "개#k\r\n\r\n"
